...
\caption{SDSS DR17 optical denominator/proxy diagnostic for radio-jet environment follow-up. The figure shows optical AGN fraction versus the local density proxy in massive hosts, with the high-density quartile rising to 0.509 $\pm$ 0.012 and the low-density quartile at 0.367 $\pm$ 0.012, defining an environment-stratified optical target set for later radio or X-ray work.}
\label{fig:topic}
\end{figure}
