...
\caption{SDSS DR17 optical denominator/proxy diagnostic for the common-denominator multiphase census. The figure shows how the BPT AGN, high-[N II]/H$\alpha$, high-[O III]/H$\beta$, low-sSFR+emission, and red+emission definitions span the same 60,000-galaxy denominator, with prevalence ranging from 0.136 to 0.418 and illustrating how tracer choice changes the apparent target pool.}
\label{fig:topic}
\end{figure}
