...
\caption{SDSS DR17 optical denominator/proxy diagnostic for the gas-fraction versus efficiency transition vector. The figure shows the 6,729-galaxy massive transition/quenched denominator, the optical BPT AGN fraction of $0.549 \pm 0.006$, and the median H$\alpha$ luminosity proxy of $\log(L_{\mathrm{H}\alpha} / \mathrm{erg~s}^{-1}) = 40.06$, identifying the target set for future CO gas-fraction versus depletion-time follow-up.}
\label{fig:topic}
\end{figure}
