# Kun reproducibility tick — 20260708T210837Z

Marker: `KUN_REPRO_AUDIT_20260708T210837Z`
...
- PDFs under aas-autopilot: 67 total; 67 start with `%PDF-`; expected-hash/byte PDF rows checked: 53; expected PDF mismatches: 0.
- Primary 9 public-linked manuscript PDFs: 9 checked; expected-hash/byte mismatches: 0.
- Lane-local expected PDFs: 26 checked; mismatches: 0.
- Logs under aas-autopilot: 56 checked; compile-ish logs: 48; fatal-marker compile logs: 5 total (0 current, 5 superseded); all-log fatal-marker files: 5.
- Manifest-like JSON files: 11 checked, 11 parse OK; manifest/receipt/inventory expected artifact rows: 225; missing/hash/byte/conflict rows: 0.
...
- Scripts checked: 25 (`*.py`/`*.sh`); syntax OK: 25; failures: 0.
- Scripts with absolute repo paths: 25; with public-network/external tokens: 20; with write/process tokens: 25.
...
/usr/bin/python3 .hermes/handoffs/galaxy-evolution/mastermind/aas-autopilot/overnight-9-papers-20260708/lanes/kun/scripts/kun_repro_audit_20260708T210837Z.py
```
...
JSON summary: `/Users/duhokim/NebulaMind/NebulaMind/.hermes/handoffs/galaxy-evolution/mastermind/aas-autopilot/overnight-9-papers-20260708/lanes/kun/artifacts/kun_repro_audit_20260708T210837Z.json`
