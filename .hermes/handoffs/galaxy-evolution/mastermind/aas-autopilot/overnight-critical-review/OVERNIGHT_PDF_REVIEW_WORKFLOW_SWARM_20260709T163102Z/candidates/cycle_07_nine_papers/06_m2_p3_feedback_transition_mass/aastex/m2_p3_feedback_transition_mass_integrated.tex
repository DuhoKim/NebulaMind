...
\begin{itemize}
\item The first stellar-mass bin with quenched fraction above 0.5 is the open high-mass tail, $\log(M_\star/M_\odot)>11.0$.
\item The optical AGN fraction peaks in the same open high-mass tail at 0.520.
