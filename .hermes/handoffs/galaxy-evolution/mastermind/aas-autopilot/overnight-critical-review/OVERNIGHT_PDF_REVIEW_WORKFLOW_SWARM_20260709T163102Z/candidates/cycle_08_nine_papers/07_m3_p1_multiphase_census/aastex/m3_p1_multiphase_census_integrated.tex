...
SDSS-only pilot; full proposal requires additional survey data. The full proposal requires: ionized, molecular, neutral, and X-ray/radio tracers measured over the same parent denominator and aperture model.
