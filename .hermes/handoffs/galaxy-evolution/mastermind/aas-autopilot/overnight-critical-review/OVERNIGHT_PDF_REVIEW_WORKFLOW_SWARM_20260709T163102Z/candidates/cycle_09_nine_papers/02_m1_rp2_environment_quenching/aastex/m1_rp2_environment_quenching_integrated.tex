...
\caption{SDSS DR17 optical density-proxy diagnostic for environmental quenching. The figure summarizes the cached optical result used as a denominator for future group-catalog analyses and highlights the equal-count density-quartile split used in the target definition.}
\label{fig:topic}
\end{figure}
