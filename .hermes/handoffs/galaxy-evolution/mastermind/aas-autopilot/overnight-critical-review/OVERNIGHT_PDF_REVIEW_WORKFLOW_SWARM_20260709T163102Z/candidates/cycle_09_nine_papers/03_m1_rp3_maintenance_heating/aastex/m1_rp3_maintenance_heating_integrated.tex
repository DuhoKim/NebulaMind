...
\begin{itemize}
\item The massive subset ($\log M_\star \geq 10.8$) contains 9,298 emission-line galaxies; 5,695 are low-sSFR by the threshold used in the local analysis sample.
...
SDSS-only pilot; full proposal requires additional survey data. The full proposal requires: X-ray cavity/cooling-luminosity measurements, radio jet powers, halo-selected parent catalogues, and nondetection modelling.
