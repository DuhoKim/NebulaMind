...
SDSS-only pilot; full proposal requires additional survey data. The full proposal requires: CO or dust-based molecular gas masses, aperture-matched SFRs, morphology, and environment labels.
