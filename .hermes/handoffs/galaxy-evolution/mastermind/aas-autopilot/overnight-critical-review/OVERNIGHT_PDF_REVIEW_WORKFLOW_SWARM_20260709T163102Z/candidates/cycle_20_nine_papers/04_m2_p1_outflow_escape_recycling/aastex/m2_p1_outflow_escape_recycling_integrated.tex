...
BPT-selected optical AGN candidates number 4,440 of 60,000 emission-line galaxies ($0.074 \pm 0.001$). Their median specific star-formation rate is $\log(\mathrm{sSFR}/\mathrm{yr}^{-1}) = -11.53$, compared with $-10.14$ for the full denominator. This optical sample defines a follow-up denominator for resolved escape/recycling work, but SDSS alone cannot measure outflow velocity or fate.


\begin{figure}
\centering
\includegraphics[width=\columnwidth]{../figures/fig-topic.pdf}
\caption{SDSS DR17 optical denominator/proxy diagnostic for outflow escape-versus-recycling follow-up. The figure summarizes the 4,440-object BPT-selected denominator and the associated median specific star-formation rate, $\log(\mathrm{sSFR}/\mathrm{yr}^{-1}) = -11.53$, used for target definition.}
\label{fig:topic}
\end{figure}
...
BPT-selected optical AGN candidates number 4,440 of 60,000 emission-line galaxies (0.074 $\pm$ 0.001), and their median specific star-formation rate is $\log(\mathrm{sSFR}/\mathrm{yr}^{-1}) = -11.53$ compared with $-10.14$ for the full denominator. The optical sample therefore defines a follow-up denominator for resolved escape/recycling work, but SDSS alone cannot measure outflow velocity or fate.
