...
| `gated-e2e-demo` | TNG100 23,722, SDSS 120,000 | TNG uses SF-weighted gas metallicity → O/H (solar-scaled). | ABSENT | ABSENT | ABSENT | novelty: NOVEL, expected_value: TENSION, citation_entailment: 2 unsupported of 4 checked |
...
* **Redshift**: ABSENT in all four JSONs, except implicitly embedded in `gated-e2e-demo`'s `spec.topic` (`the z=0 gas-phase mass-metallicity relation of galaxies`).
