...
\section{Atlas notes}
As a reminder, this atlas provides observational baselines only; it cannot independently confirm or refute physical feedback models without the integration of the listed missing observables.
...
exec
/bin/zsh -c "sed -n '1,260p' '/Users/duhokim/NebulaMind/NebulaMind/.hermes/handoffs/galaxy-evolution/mastermind/aas-autopilot/quality-sprints/RP1_QUALITY_SPRINT_CONTINUATION_20260709T030336Z/candidates/cycle_18_package/FINAL_HANDOFF.md'" in /Users/duhokim/NebulaMind/NebulaMind
 succeeded in 0ms:
...
codex
I have the main prose and the handoff context. Next I’m pulling the compile logs and line-numbered hits for the key numbers and guardrail phrases so I can separate hard risks from acceptable caveats.
exec
/bin/zsh -c "rg -n \"8,146|8\\.146|1\\.309|\\[-1\\.334,-1\\.283\\]|60,000|249,917|24\\.0%|24\\.0\\%|0\\.763|0\\.55|0\\.5 dex|association|causal|feedback|feedback only|cannot|not a causal|broad optical BPT-selected|LINER|retired|N II|\\[N II\\]\" '/Users/duhokim/NebulaMind/NebulaMind/.hermes/handoffs/galaxy-evolution/mastermind/aas-autopilot/quality-sprints/RP1_QUALITY_SPRINT_CONTINUATION_20260709T030336Z/candidates/cycle_18_package/flagship_rp1/aastex/rp1_flagship_polished.tex'" in /Users/duhokim/NebulaMind/NebulaMind
 succeeded in 0ms:
...
exec
/bin/zsh -c "rg -n \"8,146|1\\.309|\\[-1\\.334,-1\\.283\\]|60,000|249,917|24\\.0%|24\\.0\\%|0\\.763|0\\.55|0\\.5 dex|association|causal|feedback|cannot|not a causal|broad optical BPT-selected|LINER|retired|N II|\\[N II\\]\" '/Users/duhokim/NebulaMind/NebulaMind/.hermes/handoffs/galaxy-evolution/mastermind/aas-autopilot/quality-sprints/RP1_QUALITY_SPRINT_CONTINUATION_20260709T030336Z/candidates/cycle_18_package/supplementary_denominator_atlas/aastex/supplementary_denominator_atlas.tex'" in /Users/duhokim/NebulaMind/NebulaMind
 succeeded in 0ms:
13:This supplement compiles eight SDSS DR17 denominator and proxy notes that share the same fixed-size 60,000-galaxy pilot sample and the same selection-function caveats. The 60,000-galaxy sample is a local, non-random pilot-query cap, not a physical or volume-limited selection effect, so all counts and fractions remain conditional on the SDSS optical selection used here. Because \texttt{specObjID} ordering follows SDSS targeting and plate/MJD bookkeeping, this cap is not a random sky sample and introduces survey-plate and sky-coverage bias. The atlas preserves follow-up targets for environment, optical AGN incidence, stellar-mass incidence trends, tracer thresholds, gas follow-up, and simulation target vectors. Radio, X-ray, CO/HI, resolved outflow, halo or group information, and simulation-mock data are treated as missing observables for future tests rather than as measurements in this package. The sample coverage is 24.0\% of the strict four-line S/N$\geq3$ parent. It is one follow-up atlas, not eight independent causal-feedback papers. Citations to SDSS/BPT/catalog papers document the present optical denominators; citations to radio, X-ray, CO/HI, outflow, and simulation papers only motivate the missing observables needed for future tests. \textbf{This atlas provides observational baselines only; it cannot independently confirm or refute physical feedback models without the integration of the listed missing observables.}
...
exec
/bin/zsh -c "sed -n '1,240p' '/Users/duhokim/NebulaMind/NebulaMind/.hermes/handoffs/galaxy-evolution/mastermind/aas-autopilot/quality-sprints/RP1_QUALITY_SPRINT_CONTINUATION_20260709T030336Z/candidates/cycle_18_package/flagship_rp1/aastex/rp1_flagship_polished.compile.log'" in /Users/duhokim/NebulaMind/NebulaMind
 succeeded in 0ms:
note: Running TeX ...
...
codex
I’ve confirmed the manuscripts compile cleanly, and the main residual issues are about wording discipline rather than hard TeX failures. I’m now checking the table arithmetic and the few phrases that are closest to implying causality instead of association.
exec
/bin/zsh -c "nl -ba '/Users/duhokim/NebulaMind/NebulaMind/.hermes/handoffs/galaxy-evolution/mastermind/aas-autopilot/quality-sprints/RP1_QUALITY_SPRINT_CONTINUATION_20260709T030336Z/candidates/cycle_18_package/flagship_rp1/aastex/rp1_flagship_polished.tex' | sed -n '1,220p'" in /Users/duhokim/NebulaMind/NebulaMind
 succeeded in 0ms:
...
codex
The count math is consistent so far. I’m doing one last arithmetic pass with exact ratios, then I’ll summarize the concrete review findings and the safest wording edits.
exec
/bin/zsh -c "python -c \"pairs=[('8146/39553',8146/39553),('60000/249917',60000/249917),('373445/501060',373445/501060),('249917/501060',249917/501060),('176523/501060',176523/501060),('91768/501060',91768/501060),('3456/15000',3456/15000),('2710/15000',2710/15000),('7867/8146',7867/8146)];\\nfor k,v in pairs: print(k, round(v,4))\"" in /Users/duhokim/NebulaMind/NebulaMind
 exited 1 in 0ms:
  File "<string>", line 1
    pairs=[('8146/39553',8146/39553),('60000/249917',60000/249917),('373445/501060',373445/501060),('249917/501060',249917/501060),('176523/501060',176523/501060),('91768/501060',91768/501060),('3456/15000',3456/15000),('2710/15000',2710/15000),('7867/8146',7867/8146)];\nfor k,v in pairs: print(k, round(v,4))
                                                                                                                                                                                                                                                                               ^
SyntaxError: unexpected character after line continuation character

exec
/bin/zsh -c 'python -c "print(8146/39553)"' in /Users/duhokim/NebulaMind/NebulaMind
 succeeded in 0ms:
0.2059515081030516

exec
/bin/zsh -c "python -c \"pairs=[('8146/39553',8146/39553),('60000/249917',60000/249917),('373445/501060',373445/501060),('249917/501060',249917/501060),('176523/501060',176523/501060),('91768/501060',91768/501060),('3456/15000',3456/15000),('2710/15000',2710/15000),('7867/8146',7867/8146)]; print(' ; '.join(f'{k}={v:.4f}' for k,v in pairs))\"" in /Users/duhokim/NebulaMind/NebulaMind
 succeeded in 0ms:
8146/39553=0.2060 ; 60000/249917=0.2401 ; 373445/501060=0.7453 ; 249917/501060=0.4988 ; 176523/501060=0.3523 ; 91768/501060=0.1831 ; 3456/15000=0.2304 ; 2710/15000=0.1807 ; 7867/8146=0.9658

codex
CODEX_KUN_REVIEW_CYCLE_18

**Findings**
- Low-severity TeX hygiene issue: both builds succeeded, but the compile logs still show repeated `lineno.sty:296: Invalid UTF-8 byte or sequence ... replaced by U+FFFD`, plus underfull `\hbox` warnings. No fatal compile blocker, but this is a latent encoding/wrapping hygiene risk. See [flagship compile log](/Users/duhokim/NebulaMind/NebulaMind/.hermes/handoffs/galaxy-evolution/mastermind/aas-autopilot/quality-sprints/RP1_QUALITY_SPRINT_CONTINUATION_20260709T030336Z/candidates/cycle_18_package/flagship_rp1/aastex/rp1_flagship_polished.compile.log) and [supplement compile log](/Users/duhokim/NebulaMind/NebulaMind/.hermes/handoffs/galaxy-evolution/mastermind/aas-autopilot/quality-sprints/RP1_QUALITY_SPRINT_CONTINUATION_20260709T030336Z/candidates/cycle_18_package/supplementary_denominator_atlas/aastex/supplementary_denominator_atlas.compile.log).
- Medium-severity reproducibility risk: the figure includes are all relative paths like `../figures/fig-bpt.pdf` and `../figures/topic-01.pdf`. The package is reproducible only if the current directory layout is preserved. Relevant lines are in [rp1_flagship_polished.tex](/Users/duhokim/NebulaMind/NebulaMind/.hermes/handoffs/galaxy-evolution/mastermind/aas-autopilot/quality-sprints/RP1_QUALITY_SPRINT_CONTINUATION_20260709T030336Z/candidates/cycle_18_package/flagship_rp1/aastex/rp1_flagship_polished.tex#L58) and [supplementary_denominator_atlas.tex](/Users/duhokim/NebulaMind/NebulaMind/.hermes/handoffs/galaxy-evolution/mastermind/aas-autopilot/quality-sprints/RP1_QUALITY_SPRINT_CONTINUATION_20260709T030336Z/candidates/cycle_18_package/supplementary_denominator_atlas/aastex/supplementary_denominator_atlas.tex#L58).
- Medium-severity guardrail risk: the manuscripts are generally disciplined, but a few phrases still lean toward causal framing instead of pure association/denominator framing. The main one is in [rp1_flagship_polished.tex:92](/Users/duhokim/NebulaMind/NebulaMind/.hermes/handoffs/galaxy-evolution/mastermind/aas-autopilot/quality-sprints/RP1_QUALITY_SPRINT_CONTINUATION_20260709T030336Z/candidates/cycle_18_package/flagship_rp1/aastex/rp1_flagship_polished.tex#L92), where “lower bound on how much LINER-like or retired-galaxy contamination...” can read as a quantified causal decontamination statement. In the supplement, [supplementary_denominator_atlas.tex:140](/Users/duhokim/NebulaMind/NebulaMind/.hermes/handoffs/galaxy-evolution/mastermind/aas-autopilot/quality-sprints/RP1_QUALITY_SPRINT_CONTINUATION_20260709T030336Z/candidates/cycle_18_package/supplementary_denominator_atlas/aastex/supplementary_denominator_atlas.tex#L140), [supplementary_denominator_atlas.tex:192](/Users/duhokim/NebulaMind/NebulaMind/.hermes/handoffs/galaxy-evolution/mastermind/aas-autopilot/quality-sprints/RP1_QUALITY_SPRINT_CONTINUATION_20260709T030336Z/candidates/cycle_18_package/supplementary_denominator_atlas/aastex/supplementary_denominator_atlas.tex#L192), and [supplementary_denominator_atlas.tex:213](/Users/duhokim/NebulaMind/NebulaMind/.hermes/handoffs/galaxy-evolution/mastermind/aas-autopilot/quality-sprints/RP1_QUALITY_SPRINT_CONTINUATION_20260709T030336Z/candidates/cycle_18_package/supplementary_denominator_atlas/aastex/supplementary_denominator_atlas.tex#L213) are the other spots I would soften if the integrator wants maximum guardrail safety.
- The previous TeX parser issue noted in the handoff for `[N II]` appears already fixed in the current source: the table row now reads `N II Seyfert-like proxy`, so there is no current optional-argument parse blocker.

**Numeric Check**
- The core numbers are internally consistent: `8,146` pairs, `-1.309 dex`, `[-1.334,-1.283]`, `60,000` cached rows, `249,917` strict parent, and `24.0%` coverage.
- The supporting arithmetic also checks out: `60,000 / 249,917 = 24.0%`, `8,146 / 39,553 = 20.6%`, `7,867 / 8,146 = 96.6%`, `249,917 / 501,060 = 49.9%`, `176,523 / 501,060 = 35.2%`, and `91,768 / 501,060 = 18.3%`.
- I did not find a numeric inconsistency that needs correction.

**Safe Edit Recommendations**
- In [rp1_flagship_polished.tex:92](/Users/duhokim/NebulaMind/NebulaMind/.hermes/handoffs/galaxy-evolution/mastermind/aas-autopilot/quality-sprints/RP1_QUALITY_SPRINT_CONTINUATION_20260709T030336Z/candidates/cycle_18_package/flagship_rp1/aastex/rp1_flagship_polished.tex#L92), replace:
  - `the result is directly measured, reproducible, and falsifiable inside the stated denominator`
  - with:
  - `the result is directly measured inside the stated denominator and is reproducible only under the same selection and matching pipeline`
- In [rp1_flagship_polished.tex:92](/Users/duhokim/NebulaMind/NebulaMind/.hermes/handoffs/galaxy-evolution/mastermind/aas-autopilot/quality-sprints/RP1_QUALITY_SPRINT_CONTINUATION_20260709T030336Z/candidates/cycle_18_package/flagship_rp1/aastex/rp1_flagship_polished.tex#L92), replace:
  - `lower bound on how much LINER-like or retired-galaxy contamination and related selection effects contribute`
  - with:
  - `evidence that LINER-like or retired-galaxy contamination and related selection effects materially contribute`
- In [supplementary_denominator_atlas.tex:140](/Users/duhokim/NebulaMind/NebulaMind/.hermes/handoffs/galaxy-evolution/mastermind/aas-autopilot/quality-sprints/RP1_QUALITY_SPRINT_CONTINUATION_20260709T030336Z/candidates/cycle_18_package/supplementary_denominator_atlas/aastex/supplementary_denominator_atlas.tex#L140), replace:
  - `AGN or feedback-candidate prevalence`
  - with:
  - `AGN or tracer prevalence`
- In [supplementary_denominator_atlas.tex:192](/Users/duhokim/NebulaMind/NebulaMind/.hermes/handoffs/galaxy-evolution/mastermind/aas-autopilot/quality-sprints/RP1_QUALITY_SPRINT_CONTINUATION_20260709T030336Z/candidates/cycle_18_package/supplementary_denominator_atlas/aastex/supplementary_denominator_atlas.tex#L192) and [supplementary_denominator_atlas.tex:213](/Users/duhokim/NebulaMind/NebulaMind/.hermes/handoffs/galaxy-evolution/mastermind/aas-autopilot/quality-sprints/RP1_QUALITY_SPRINT_CONTINUATION_20260709T030336Z/candidates/cycle_18_package/supplementary_denominator_atlas/aastex/supplementary_denominator_atlas.tex#L213), replace:
  - `causal physical claims` / `independent causal-feedback papers`
  - with:
  - `physical-inference claims` / `independent follow-up papers`
- Keep the repeated negations already in place, especially `not an AGN-feedback measurement`, `not a causal claim`, `not a physical-feedback measurement`, and `not a direct simulation comparison`. Those are doing the right guardrail work.
- If the package is going to move directories, convert the relative figure paths to layout-stable paths first; otherwise, keep the current directory structure unchanged.
- If there is one follow-up hygiene pass, search for the UTF-8 source of the repeated `lineno.sty` warning; that is the remaining low-level compile noise.

**Safety Ledger**
Read-only local review only. I inspected the four requested package files and the associated compile logs, ran harmless read-only shell commands, and did not edit files, run git write commands, access credentials, call APIs, or touch any public/live roots.
tokens used
48,654
CODEX_KUN_REVIEW_CYCLE_18
...
elapsed_s=147.2
timed_out=False
finished_utc=2026-07-09T04:58:58Z
