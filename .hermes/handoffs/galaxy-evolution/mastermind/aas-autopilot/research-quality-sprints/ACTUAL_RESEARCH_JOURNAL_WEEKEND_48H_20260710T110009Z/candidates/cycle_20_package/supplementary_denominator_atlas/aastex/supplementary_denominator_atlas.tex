...
\section{Atlas notes}
As a reminder, each atlas entry is a baseline-plus-follow-up checklist, not a standalone physical-mechanism result. The missing observables listed in Table~\ref{tab:atlas-followup} are required before any physical inference from these optical baselines.
