...
\section{Flagship provenance map}
The flagship result is anchored by the following custody-backed local files.
\begin{deluxetable*}{p{0.47\textwidth}p{0.12\textwidth}p{0.29\textwidth}p{0.1\textwidth}}
\tabletypesize{\scriptsize}
\tablecaption{Flagship source-file provenance for the matched-control result.\label{tab:flagship-provenance}}
\tablehead{\colhead{Source file} & \colhead{Rows} & \colhead{SHA256} & \colhead{Role}}
\startdata
\texttt{SDSS\_AGN\_SFR\_PILOT\_20260708T122000Z/data/analysis\_sample\_bpt.csv} & \(\sim 60{,}000\) & \texttt{6f982fa5778c3900239149b28729f701390fe393a164b95236229adc1e422883} & analysis denominator \\
\texttt{SDSS\_AGN\_SFR\_PILOT\_20260708T122000Z/data/matched\_agn\_sf\_pairs.csv} & \(\sim 8{,}146\) & \texttt{4ea53af867cccccb2b68b81557ff84fe90ec3f13e0512ffbdc977fa7216996fd} & matched-pair result \\
\enddata
\tablecomments{These are the two raw flagship CSV anchors named in the custody receipt; the retained result JSON is also inventoried there, but the table is limited to the raw denominator and matched-pair files requested for cross-checking.}
\end{deluxetable*}
...
\bibitem[Dawson et al.(2013)]{dawson2013} Dawson, K.~S., Schlegel, D.~J., et al. 2013, AJ, 145, 10; ADS bibcode: 2013AJ....145...10D
...
\bibitem[Dominguez Sanchez et al.(2018)]{dominguezsanchez2018} Dominguez Sanchez, H., Huertas-Company, M., Bernardi, M., et al. 2018, MNRAS, 476, 3661; ADS bibcode: 2018MNRAS.476.3661D
