...
**Primary observables.** Median $\Delta\log\mathrm{sSFR}$, the matched-pair distribution width, the stability of the offset across AGN tracers, and the sensitivity of the result to the control sample definition.
