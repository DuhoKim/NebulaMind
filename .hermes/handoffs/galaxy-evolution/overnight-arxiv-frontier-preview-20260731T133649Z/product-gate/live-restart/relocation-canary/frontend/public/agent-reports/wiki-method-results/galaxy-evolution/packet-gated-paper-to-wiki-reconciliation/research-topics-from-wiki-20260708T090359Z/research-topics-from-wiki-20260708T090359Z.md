...
- RP-1: [A Matched-Control SDSS DR17 Pilot Test of Specific Star Formation in Optical AGN Hosts (PDF)](sdss_agn_sfr_pilot_aas.pdf)
- RP-2: [SDSS density proxy for environmental quenching: an SDSS DR17 pilot (PDF)](m1_rp2_environment_quenching_aas.pdf)
- RP-3: [Optical-AGN denominator for maintenance-heating follow-up: an SDSS DR17 pilot (PDF)](m1_rp3_maintenance_heating_aas.pdf)
