#!/usr/bin/env python3
"""Fetch public Crossref title candidates for selected item-06 rows."""
...
SELECT = "DOI,title,author,published-print,published-online,container-title,volume,page,type,URL"
...
def fetch_title(title: str, max_attempts: int = 5) -> dict[str, Any]:
    query = urllib.parse.urlencode(
        {"query.bibliographic": title, "rows": 5, "select": SELECT}
    )
...
def main() -> int:
    ...
    artifact = {
        "schema_version": 1,
        "status": "PUBLIC_CROSSREF_TITLE_CANDIDATES_CAPTURED",
