#!/usr/bin/env python3
"""Read-only B3 queue edit checker."""
...
DEFAULT_SNAPSHOT_DIR = Path(
    ...
    "pre_edit_queue_snapshot_b3_20260705T044944Z"
)
DEFAULT_OUTPUT = Path(
    ".hermes/handoffs/hwao_b3_source_position_20260705T044944Z/"
    "kun_queue_checker_results_b3_post_apply.json"
)
DEFAULT_EDITED_IDS = "28123,28127,28139,28143,28151,28158"
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Read-only checker for B3 queue edits.")
