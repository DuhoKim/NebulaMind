...
Status: `DOCS_ONLY_B2_APPLIED_10_OF_36_SQL_LOCKED_NO_ACTIVE_EXECUTION_PHRASE`  
...
Plain English: this is a 36-ticket checklist for humans/operators. Ten rows now have docs-only source-position/human decisions; the other 26 remain pending. No rows are moved by this artifact.
...
- queue tickets: `36`
- decision counts: `{'leave_archival': 2, 'pending': 26, 'relink': 5, 'route_kinetic_radio': 3}`
- source-position status counts: `{'abstract_only_verified': 10, 'pending': 26}`
