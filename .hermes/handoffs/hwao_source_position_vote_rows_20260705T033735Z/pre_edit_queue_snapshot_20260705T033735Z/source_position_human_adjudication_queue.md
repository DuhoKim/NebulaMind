...
Status: `QUEUE_PREPARED_DOCS_ONLY_HELPER_QA_PATCHED_NO_ACTIVE_EXECUTION_PHRASE`  
Helper QA patch UTC: `2026-07-05T02:02:00Z`  

Plain English: this is a 36-ticket checklist for humans/operators. It does not move rows. It adds the exact fields needed before any later write packet can exist.

Hard locks: no apply SQL, no DB writes, no trust recompute, no prose/wiki publish, no runtime deploy/restart, no git commit/push/merge, active phrase `NO ACTIVE EXECUTION PHRASE`.
...
- queue tickets: `36`
- decision counts: `{'pending': 36}`
- source-position status counts: `{'None': 36}`
- vote-dependent rows: `28060, 28091, 28095, 28111, 28141, 28155`
...
|---:|---|---|---|---|---|---|---|---|
| 28060 | pending | pending | pending | pending (1) | 2942 | arxiv:2604.15438 / same: 28074,28091,28155 | Surveying the Whirlpool at Arcseconds with NOEMA (SWAN). IV. Extent of active ga | Open source and decide vote handling before any future write. |
...
| 28091 | pending | pending | pending | pending (1) | 2943,2942 | arxiv:2604.15438 / same: 28060,28074,28155 | Surveying the Whirlpool at Arcseconds with NOEMA (SWAN). IV. Extent of active ga | Open source and decide vote handling before any future write. |
| 28095 | pending | pending | pending | pending (1) | 2943,2946,2947 | arxiv:2009.11175 / same: 28087,28108,28111,28133 | arXiv:2009.11175 | Open source and decide vote handling before any future write. |
...
| 28111 | pending | pending | pending | pending (1) | 2946,2947 | arxiv:2009.11175 / same: 28087,28095,28108,28133 | arXiv:2009.11175 | Open source and decide vote handling before any future write. |
...
| 28141 | pending | pending | pending | pending (1) | 2943 | arxiv:1706.08987 / same: none | arXiv:1706.08987 | Open source and decide vote handling before any future write. |
...
| 28155 | pending | pending | pending | pending (1) | 2942,2946 | arxiv:2604.15438 / same: 28060,28074,28091 | Surveying the Whirlpool at Arcseconds with NOEMA (SWAN). IV. Extent of active ga | Open source and decide vote handling before any future write. |
