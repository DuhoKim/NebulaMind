...
Role: Goru mechanical checker.
Tasks:
1. Count rows: 5 claim rows, 35 evidence rows, 35 page-citation rows, 12 claim-resolution rows.
2. Verify all claim debate_stance values <=20 and all page-citation match_method values <=32 and equal step9e_source_registry_key.
3. Verify rollback SQL has all-zero/all-full guard and order_idx 732-736 claim scope.
4. Verify runbook files exist and contain exact phrase gating.
Write report: /Users/duhokim/NebulaMind/NebulaMind/.hermes/handoffs/overnight-step9e-readonly-hardening-20260703T1621Z/GORU_OVERNIGHT_STEP9E_MECHANICAL_REPORT.md
Required final line: GORU_OVERNIGHT_STEP9E_MECHANICAL_DONE
