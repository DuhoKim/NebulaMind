...
Role: Goru mechanical exact-count and safety verifier.
Task:
1. Parse JSON/JSONL counts mechanically: 26 match rows, 25 insert rows, 1 existing row, 6 continuity rows.
2. Confirm source nums for insert candidates are exactly 1-13 and 15-26.
3. Confirm hard-stop fields are zero and manifest execution_authorized=false.
4. Confirm GO/NO-GO has an insert-heavy NO_GO and no mutation/unlock language.
5. Report PASS, PASS_WITH_PATCHES, or BLOCKED.

Write report exactly to:
/Users/duhokim/NebulaMind/NebulaMind/.hermes/handoffs/quintet-step9c-readonly-db-evidence-match-20260703T1354Z/GORU_STEP9C_MECHANICAL_REPORT.md

Required marker line:
GORU_STEP9C_MECHANICAL_REPORT_DONE
