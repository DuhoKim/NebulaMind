...
| **kimi** (Kimi K3) | PRIMARY route **PAUSED 2026-08-20 14:3x KST — Moonshot wallet at $0.00** (floor rule invoked; needs Duho top-up). FREE fallback for small gates: `hermes chat --provider nous -m moonshotai/kimi-k3` in a FRESH session **under ~80K context — it 400s beyond that** (Hwao, 2026-08-20) | card "Moonshot / kimi (K3 direct)": $0.00, tone bad | Wallet floor $10: below it, gating pauses and surfaces to Duho; gate notes log purpose | Metered-spend discipline; Nous-route gates bill the Nous sub |
