...
<!--/SEAT-REDACT-->
<!--SEAT-REDACT-->
> *(Master only — the rule the script implements: `DERIVED_STANDARD_OR_MEASURED_ONLY` (the token `DERIVED_STANDARD_OR_MEASURED_ONLY` of V10–V26, identical membership) when every root origin is `DERIVED`, `STANDARD` or
