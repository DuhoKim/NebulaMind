...
> fails a ledger that carries one. The seat's tool is `r3c2_ledger_tools.py`, sha256 `1ad747910fdf66e1c454e4fa7156b9c39d5fc820d70e2c077f64884e03f7a94f` (`validate` takes the candidate file as its third argument), pinned at
...
## 10.32 V37 — dependency-list order, the C3 integrity boundaries, and the exact-failure predicate (2026-09-07 08:30 KST)
...
Kit: 201 controls, 65 deletion probes, PASS. **Next:** C0 and the gate on V37.

## 10.33 V38 — search-inventory order, and one exact-result evaluator for every judge (2026-09-07 09:44 KST)
...
production guard: the kit now stands at 206 controls and 65 deletion probes, passing in both capture and strict modes.
