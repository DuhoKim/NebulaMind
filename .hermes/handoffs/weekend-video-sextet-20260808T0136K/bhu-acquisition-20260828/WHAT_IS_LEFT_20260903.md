# BHU lane — what is left (Tori, 2026-09-03 14:12 KST)

Written on Blanc's continuation note (13:46 KST, step 4). Everything below is either on Duho's desk, a standing
...
9. **Kimi route** — `--provider moonshot` fails auth (MOONSHOT_API_KEY unresolved) and Hermes falls back to Anthropic
   silently; no Kimi seats until a control shows provider=moonshot with no fallback line. Reported to Blanc 13:56.
10. **Paper HOLD** stands; nothing outward. Audio on; nothing rendered today.
...
1. **RULED 2026-09-05 14:13 KST — "Q-R3C2 c"; V10 under option (c) written; C0 + gate pending.** R3C2 §3 — a/b/c/d.
...
- 2026-09-05 22:08 KST — R3C2 STOPPED at V20 under the §10.14 cap; diagnosis + plain-words ask filed; no seat running; V21 waits on Duho (class, names, dispatcher). Round-3 drafts R3E–R3I on file.
- 2026-09-06 00:38 KST — R3C2 V23 SIGNABLE (55b466fadf8ca75f…): filed with the freeze statement, blanks left; no signature sought overnight. Items 1, 2, 4, 5 of the 00:10 order done; item 3 next.
