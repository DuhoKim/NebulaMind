...
Built from master sha256 `d6695c06c78c4735cb155269737175fbe55b7cdff0161cfccd0e85a71b21aca1` by `r3c2_build_seat_packet.py`.
...
`C4_PATTERN_BLIND=PASS|FAIL|NOT_RUN`.
...
- **C5b — no cross-lane access.** Print every path opened, each marked `IN_SCOPE` or `OUT_OF_SCOPE`; **any
  `OUT_OF_SCOPE` row fails the control.** `C5B_NO_CROSS_LANE=PASS|FAIL|NOT_RUN`. 
