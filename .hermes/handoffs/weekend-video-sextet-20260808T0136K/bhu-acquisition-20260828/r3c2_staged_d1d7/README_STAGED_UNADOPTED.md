# r3c2_staged_d1d7 — STAGED, UNADOPTED tooling for the D1 / D7 / batch candidates (revision 4, 2026-09-06 20:38 KST)
...
- `r3c2_staged_tests.py` — 111 controls: positives, negatives asserting the EXACT failure set, and 38 deletion probes (the check on a marked line
