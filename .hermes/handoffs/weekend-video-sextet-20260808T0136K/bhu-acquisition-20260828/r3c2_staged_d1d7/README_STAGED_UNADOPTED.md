# r3c2_staged_d1d7 — STAGED, UNADOPTED tooling for the D1 / D7 / batch candidates (revision 2, 2026-09-06 20:38 KST)
...
- `r3c2_staged_tests.py` — 84 controls: positives, negatives asserting the EXACT failure set, and 29 deletion probes (the check on a marked line
  is neutralised in a copy of the tool; the matching negative must then PASS). Run from this directory: `/usr/bin/python3 -E r3c2_staged_tests.py`
