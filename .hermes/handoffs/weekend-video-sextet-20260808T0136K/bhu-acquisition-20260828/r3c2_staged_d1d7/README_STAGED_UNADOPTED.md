# r3c2_staged_d1d7 — STAGED, UNADOPTED tooling for the D1 / D7 / batch candidates (V29, 2026-09-06 20:38 KST)

Nothing here is installed. Since V26 the tools here are the SAME bytes as the pinned tools (`r3c2_ledger_tools.py` sha256 a68ad2b259719d76…, and the lane, batch, manifest and builder tools),
...
- `r3c2_staged_tests.py` — 165 controls: positives, negatives asserting the EXACT failure set, and 57 deletion probes (the check on a marked line
