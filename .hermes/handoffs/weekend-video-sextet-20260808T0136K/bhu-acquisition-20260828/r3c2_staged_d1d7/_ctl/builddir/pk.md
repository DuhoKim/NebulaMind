...
Built from master sha256 `f4edb5145b5c150c43a6550b30f0beca1d08bf4675305383e7860c3657f951fd` by `r3c2_build_seat_packet.py`.
...
- **C1 — denominator.** Claims **included**, claims **excluded** (with the exclusion ledger of §3), and the attempts
  ...
  `census` and `validate` run. The files named below are those joined files.** 
