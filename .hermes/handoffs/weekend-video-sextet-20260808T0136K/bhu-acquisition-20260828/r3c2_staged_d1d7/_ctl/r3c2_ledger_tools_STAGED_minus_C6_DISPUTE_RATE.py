...
def cmd_audit_compare(seal1, ac, ax, sc, sx, sl, sel, seal2, red, out):
    ...
    if n_inc_sealed and disputes/n_inc_sealed>0.10: _probe_noop(f"AUDIT_INCLUSION_DISPUTED above 10% of the sealed denominator: {disputes}/{n_inc_sealed}")  # PROBE-DELETED:C6_DISPUTE_RATE
