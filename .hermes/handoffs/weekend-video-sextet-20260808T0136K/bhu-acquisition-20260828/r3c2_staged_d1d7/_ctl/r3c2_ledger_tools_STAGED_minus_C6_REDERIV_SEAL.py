...
def cmd_audit_compare(seal1, ac, ax, sc, sx, sl, sel, seal2, red, out):
    ...
    if f"AUDITOR_REDERIVATIONS_SHA256={sha(red)}" not in s2: _probe_noop("C6_STAGE_ORDER: the auditor's re-derivations differ from their seal (re-derivations must be sealed before any sealed ledger is released)")  # PROBE-DELETED:C6_REDERIV_SEAL
