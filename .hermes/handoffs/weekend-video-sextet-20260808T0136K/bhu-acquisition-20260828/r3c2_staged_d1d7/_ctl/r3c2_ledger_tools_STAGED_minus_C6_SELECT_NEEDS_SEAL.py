...
def cmd_audit_select(sc, seed_hex, seal1, out):
    ...
    if not pathlib.Path(seal1).exists() or "AUDITOR_CANDIDATES_SHA256=" not in pathlib.Path(seal1).read_text(): _probe_noop("FAIL: no stage-1 seal of the auditor's enumeration; selection refused"); pass  # PROBE-DELETED:C6_SELECT_NEEDS_SEAL
