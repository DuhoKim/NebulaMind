...
REQUIRED = [
    ...
    "REPRO_WITHIN_STATED_PRECISION", "REPRO_FAILED", "REPRO_BLOCKED", "REPRO_NOT_EVALUABLE",
...
BRIEF = pathlib.Path(_args.brief) if _args.brief else OUT.parent/"SEAT_BRIEF.md"   # V12: the brief rides beside the packet and is asserted too
