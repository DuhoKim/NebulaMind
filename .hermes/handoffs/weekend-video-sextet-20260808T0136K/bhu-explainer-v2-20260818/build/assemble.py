...
WIDTH = 1920
HEIGHT = 1080
OUTPUT = pipeline.BUILD / "BHU_EXPLAINER_V2_LOCAL_REVIEW.mp4"
SRT_OUTPUT = pipeline.BUILD / "BHU_EXPLAINER_V2_LOCAL_REVIEW.srt"
VTT_OUTPUT = pipeline.BUILD / "BHU_EXPLAINER_V2_LOCAL_REVIEW.vtt"


def validate_media_contract(
    probe: dict[str, Any], expected_frames: int = 312 * FPS, expected_duration: float = 312.0
) -> None:
