...
WIDTH = 1920
HEIGHT = 1080
OUTPUT = pipeline.BUILD / "BHU_NEUTRON_STAR_EXPLAINER_LOCAL_REVIEW.mp4"
SRT_OUTPUT = pipeline.BUILD / "BHU_NEUTRON_STAR_EXPLAINER_LOCAL_REVIEW.srt"
VTT_OUTPUT = pipeline.BUILD / "BHU_NEUTRON_STAR_EXPLAINER_LOCAL_REVIEW.vtt"


def validate_media_contract(
    probe: dict[str, Any], expected_frames: int = 313 * FPS, expected_duration: float = 313.0
) -> None:
