...
**Corpus-wide WARRANT column, added 2026-09-03 on Duho's overnight order ("Hwao a, Tori b"; prereg
`bhu-acquisition-20260828/WARRANT_AUDIT_PREREG_20260903.md`).** Every base-layer paper now carries a one-line
`Warrant (2026-09-03)` cell under its header, with the full table in `WARRANT_TABLE_20260903.md`. Tokens: calibrated
7 BORROWED · 31 BORROWED (+ pinned challenge) · 51 UNDERIVED · 44 EXPLICIT · 1 EXPLICIT; directional 54 DERIVED, 6 and
...
it was is withdrawn. In that text the density claim and the mass figure sit in **one sentence with
no intermediate step**, the whole inference carried by the words "from which"; the publisher's
...
publisher version of record is still owed before any stronger wording is considered* *(STALE since 2026-08-30: the version of record IS pinned and word-for-word identical to the preprint on every load-bearing number — see the entry body; caught by the 2026-09-02 synthesis gate)* (`b13`, arithmetic confirmed by both seats; shortfall 3.1–4.1 decades, and refining the inputs widens it). *(Read "DOES NOT FOLLOW" until CGATE_Q4 pointed out that converts a failure to reproduce into a proof of non-entailment and prejudges **open question 2**, which is still Duho's.)* **Contrast, added at the Q6 ruling: the paper's best-warranted content is its Papapetrou nonsingularity THEOREM (both seats verified the derivation; domain in the entry's prose) — while the floor claim — retained as the paper-level tier under the Q6 ruling — is its unreproduced corollary.** | the four-dimensional ECKS density/minimum-mass chain, via the LHC route. **Not a direct BHU falsifier.** |
...
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_EXPLICIT` — borrowed inputs: none Blind double 09-03: confirmed.
...
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_CONSTRUCTION_ASSERTED` — borrowed inputs: continual-creation cosmology (SOURCE lines 95–100); Dirac infinite-negative-density ether (SOURCE lines 100–105); infinite-time probability-one premise (SOURCE lines 95–100) Blind double 09-03: confirmed.
**Deep audit (2026-09-02, STEP 3 queue draw #30; blind double codex + claude-seat, both `AUDIT_HOLDS_CONSISTENCY_ONLY`; `bhu-acquisition-20260828/ENTRY2_DEEP_RECONCILIATION_20260902.md`):** the identification is the thesis ("the whole of our observable universe is probably a black hole", lines 86–94) with infinite nesting; no equation, no numerical check (R = 2GM/c² never appears); every observation-bearing sentence accommodates known facts. Record note: the letter's one physical statement — interior density "should be almost infinite" (lines 100–101) — points the wrong way (a Hubble-scale hole's mean density is ≈ critical). **Tier UNCHANGED.**
...
**OCR pass (2026-09-03 16:03 KST):** the AIP PDF text layer is empty (the 09-02 audit read the page images); a tesseract OCR text is now pinned as `stuckey_1994_observable_universe_black_hole_ajp62_788_ocr_clean.txt` so future receipts can cite line numbers. Content already audited; no re-audit.
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_CONSTRUCTION_DERIVED` — borrowed inputs: Birkhoff theorem (SOURCE p. 790); junction conditions from MTW (SOURCE pp. 790–793); Schwarzschild interface trajectories adapted from ref. 14 (SOURCE pp. 790–791) Blind double 09-03: confirmed.
...
**Study K2 (2026-09-03 17:18 KST; `bhu-acquisition-20260828/K2_RESULT_20260903.md`):** the open clause "shell-bearing junctions not excluded" is answered at Pathria's placement — the only shell a null junction on the horizon admits is pressure-only with the dominant energy condition violated; the smooth comoving surface at maximum expansion (r_b = 1) recollapses. Tier, domain and warrant token untouched. **Ruled 2026-09-03 17:18 KST (Duho, relay via Blanc 17:17 KST, verbatim "as Tori's rec, both a").**
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_PROOF_CONTESTED` (the domain was narrowed yesterday by a third seat; the surviving no-go is proved here, the struck "static" clause was not) — borrowed inputs: FLRW perfect-fluid interior and Kottler vacuum exterior ansatz (SOURCE lines 43–66, 245–282); smooth timelike junction and T-timelike-coordinate assumption (SOURCE lines 534–539, 603–689); Pathria boundary choice r_b = 1 (SOURCE lines 1063–1072) Blind double 09-03: confirmed.
**Deep audit (2026-09-02, STEP 3 queue draw #28; SPLIT — codex `AUDIT_HOLDS_THEORETICAL_OBSTRUCTION`, claude-seat `AUDIT_DOMAIN_NARROWER`, third seat with mandated sanity checks `DOMAIN_NARROWER`; `bhu-acquisition-20260828/ENTRY4_DEEP_RECONCILIATION_20260902.md`, `ENTRY4_THIRD_SEAT_ADJUDICATION.md`):** at r_b = 1 the junction gives B·(Ȧ² + c²B) = 0 with two branches; the "static" branch violates Knutsen's own eqs. 19/24, and the surviving branch is a non-static Oppenheimer–Snyder ball with surface on or inside the horizon, touching it only at A_max = R_s — the algebra supports "at/inside the horizon", not "static … cannot describe our expanding universe" (lines 1084–1088). The surviving content realises Pathria's a_max = R_s identity rather than refuting it, so the obstruction label is itself tier-adjacent. **STAMPED DOMAIN AND TIER UNCHANGED pending Duho — packet filed 2026-09-02 21:20.**
...
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_CONSTRUCTION_ASSERTED` — borrowed inputs: universe-as-black-hole identification from Alfonso-Faus 2010 (SOURCE lines 34, 56–57); black-hole quantization relation from He and Ma 2011 (SOURCE lines 34, 43–46); R ≈ 10^28 cm, M ≈ 10^56 g, t0 ≈ 4.3×10^17 s stated without source (SOURCE line 57) Blind double 09-03: confirmed.
...
**Study K1 stage 1 (2026-09-03 17:18 KST; `bhu-acquisition-20260828/K1S1_RESULT_20260903.md`):** the direction is now COMPUTED for two parameters — black-hole production RISES monotonically with the primordial amplitude through the Planck value (against the premise) and FALLS with the neutron-star mass cap across 2.5 M☉ (with it, but no maximum). Two blind seats, unanimous; controls C1–C4 pass; PBH channel empty. Warrant note only; `W_DIRECTION_ASSUMED` token and tier untouched. **Ruled 2026-09-03 17:18 KST (Duho, relay via Blanc 17:17 KST, verbatim "as Tori's rec, both a").**
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_DIRECTION_ASSUMED` (both blind seats; packet of 01:00 extended) — the local-maximum concentration that carries the direction is assumed in the author's words, "it will be important to show that (i) and (ii) do, indeed, follow … For the moment it is sufficient to assume them" (lines 220–227); the direction then follows only definitionally plus a typicality assumption (229–230). **Ruled 2026-09-03 01:1x KST (Duho, RELAY via pane, "a — keep tier, carry the warrant flag"): tier stays QUALITATIVE-DIRECTIONAL; W_DIRECTION_ASSUMED carried as a ruled flag, not a demotion.** Blind double 09-03: confirmed.
**Deep audit (2026-09-02, STEP 3 queue draw #26; blind double codex + claude-seat, both `AUDIT_HOLDS_QUALITATIVE_DIRECTIONAL`; `bhu-acquisition-20260828/ENTRY6_DEEP_RECONCILIATION_20260902.md`):** the one prediction is a direction — "most changes in their values should lead to decreases in the expected number of black holes" (lines 231–238) — with no tolerance or boundary; NO neutron-star upper mass appears (the only mass is the schematic 10 M☉ progenitor cutoff, lines 655–660), confirming the batch-9 correction; "local maximum" is "sufficient to assume" (lines 220–227). Notable: the paper's own worked Δm test came out ~10× the wrong way — "our hypothesis is contradicted, given the assumptions" (lines 788–791) — rescued by dropping an assumption. **Tier UNCHANGED.**
...
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_BORROWED` — borrowed inputs: Brown–Bethe maximum-mass calculation (../brown-prl.txt:25-35); VM/HLS and kaon-condensation chain (../brown-prl.txt:36-45) Blind double 09-03: confirmed.
...
**Study K1 stage 1 (2026-09-03 17:18 KST; `bhu-acquisition-20260828/K1S1_RESULT_20260903.md`):** the premise under the 2.5 M☉ bar (a local maximum of black-hole production) fails for the primordial amplitude in a semi-analytic model with a declared nuisance box; Rothman & Ellis's "primary requirement" is answered without needing primordial black holes (their channel is empty at the Planck amplitude). Standing LIVE and tier untouched; the falsifier still tests what Smolin stated. Stage 2 (population synthesis) was preregistered, launched, and stopped by Duho at 19:06 KST ("a"; `K1S2_STOPPED_20260903.md`); K1 closes at stage 1. **Ruled 2026-09-03 17:18 KST (Duho, relay via Blanc 17:17 KST, verbatim "as Tori's rec, both a").**
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_BORROWED` — borrowed inputs: Bethe–Brown kaon-condensation calculations [52–54] (../bhu-reading-20260823/sources/smolin_2004_cns_clean.txt:235-256); conventional-EoS mass result [55] (../bhu-reading-20260823/sources/smolin_2004_cns_clean.txt:253-255) — pinned challenge: Rothman & Ellis 1993, Harrison 1995, Silk 1997 (attack the selection inference; record §0 "DISPUTED")
...
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_MIXED` — borrowed inputs: Rindler elliptic identification of antipodal horizons (SOURCE lines 23, 243–245); throat source/energy-condition result [V; Gue] (SOURCE lines 258–264) Blind double 09-03: confirmed.
**Deep audit (2026-09-02, STEP 3 queue draw #16; blind double codex + kimi, both `AUDIT_HOLDS_CONSISTENCY_ONLY`; `bhu-acquisition-20260828/ENTRY8_DEEP_RECONCILIATION_20260902.md`):** the isotropic-coordinate inversion r → r_g²/(16r) plus an imposed gluing at r = r_g/4 — the paper concedes the glued metric needs a nonzero (distributional) source at the throat (lines 258–262); the Raychaudhuri sign jump is a property of that patching; the exterior is exactly Schwarzschild, so "for distant observers, both solutions are indistinguishable" (line 250) — no exterior test; the "new universe inside" is "suggest[ed]" (lines 24–25), pure GR, nothing about it derived. **Tier UNCHANGED.**
...
**Study K3 step 1 (2026-09-03 19:34 KST; `bhu-acquisition-20260828/K3S1_RESULT_20260903.md`):** the closure s² = ⅛(ℏcn)² (L90–91) is a CONVENTION, not a derived unpolarized average — three blind seats by two methods find the average of the squared spin density linear in n; the ⅛ needs a prescription the definitions do not supply. **Gasperini source test (2026-09-04; `bhu-acquisition-20260828/GASPERINI_K3_RESULT_20260904.md`, check sheet, independent second seat):** the newly pinned 1986 version of record defines the same spin-fluid scalar and states `σ² = ℏ²⟨n²⟩/8`, but provides no microscopic averaging derivation; `CONVENTION_CONFIRMED` 2/2. Warrant field only; token `W_ROUTE_NAMED_ONLY` and tier untouched. **Ruled 2026-09-03 19:34 KST (Duho, typed into the lane pane, verbatim "as your rec" = option (a); provenance row pending Blanc confirmation).**
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_ROUTE_NAMED_ONLY` — borrowed inputs: random-spin averaging (SOURCE lines 74-75); unpolarized-spin relation s²=(ℏcn)²/8 (SOURCE lines 90-93); closed FLRW ansatz (SOURCE line 77); WMAP, H₀, Ω_R, and relic-neutrino density inputs (SOURCE lines 140-143); Kerr-radius relation and comparison model (SOURCE lines 243-249) Blind double 09-03: confirmed.
**Deep audit (2026-09-02, STEP 3 queue draw #2; blind double codex + claude-seat, both `AUDIT_HOLDS_PROSPECT`; `bhu-acquisition-20260828/ENTRY9_RECONCILIATION_20260902.md`):** Ω_S = −8.6×10⁻⁷⁰ reproduces (−8.8×10⁻⁷⁰) only by summing all six neutrino species into one n before squaring — an unstated step; single-species gives −2.5×10⁻⁷¹. The number is placed ~67 orders beyond any Ω precision, so it cannot calibrate a falsifier. Flatness/horizon are bounce-epoch consequences of a closed model (k = +1 written in, line 77) fed with WMAP Ω = 1.002 as an input, not a propagated present-day prediction. The PROSPECT route (lines 243–249: Kerr-axis corrections "could then couple to other fields"; a < 26 km) names no observable, sign, amplitude or instrument. **Tier UNCHANGED.** Side: line 214's ε_R = 1.1×10¹¹⁶ J m⁻³ disagrees with the paper's own Eq. (16) scaling (≈ 7.7–7.9×10¹¹⁶) — the quantity the erratum was suspected to correct. *Erratum custody made precise: PLB 701, 672 is verified to exist and postdate both arXiv versions, but its content was never obtained (`ERRATUM_CHASE_20260820.md`); "pinned at the Phase 1 custody audit" above refers to that existence record, not to the text.*
**RQ-B map (BHU Lane 2, 2026-09-01; Duho ruling q4 = annotate, keep tier):** The interior transfer function (parent -> torsion bounce -> daughter observable) is **UNDETERMINED by the published literature** -- the mechanism has field equations for the homogeneous BACKGROUND bounce but NO perturbation action; the closure is not fixed (a spin/number isocurvature mode gives delta-p_nad != 0), the bounce matching is undetermined (the PRD-85 realization is a cusp), and the particle-production constant beta is free. Poplawski himself states the density-fluctuation derivation "remains to be done." So the branch's falsifier question is genuinely OPEN (not closed by omission), needing an original linearized Einstein-Cartan perturbation action. Blind-double + independent third read (kimi): codex+kimi UNDETERMINED, agy NEW_FALSIFIER (outlier, assumed the adiabatic closure). **Tier UNCHANGED.** See `RQ_B_RECONCILIATION_20260901.md` + `RQ_B_kimi_CRUX_RESULT.md`.
...
**Study K3 step 1 (2026-09-03 19:34 KST; `bhu-acquisition-20260828/K3S1_RESULT_20260903.md`):** this paper prints two closures for what its own projection makes one quantity — ⟨s²⟩ = ¾n² (L113) and s² = ⅛n² (L121) — six times apart; neither follows from the unpolarized average (linear in n). **Gasperini source test (2026-09-04; `bhu-acquisition-20260828/GASPERINI_K3_RESULT_20260904.md`):** the cited 1986 source also states, but does not microscopically derive, the same scalar's ⅛ closure (`CONVENTION_CONFIRMED` 2/2); this does not cure the ¾-versus-⅛ conflict. Internal factor-six inconsistency recorded; warrant field only; token `W_MIXED` and tier untouched. **Ruled 2026-09-03 19:34 KST (Duho, typed into the lane pane, verbatim "as your rec" = option (a); provenance row pending Blanc confirmation).**
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_MIXED` — borrowed inputs: Kerlick/Hehl–Datta Dirac-torsion result (SOURCE lines 68-74); asserted average ⟨s²⟩=3n²/4 (SOURCE lines 75-83); closed FLRW ansatz imported “as in [16]” (SOURCE lines 100-108); ultrarelativistic equilibrium closure (SOURCE lines 118-121) Blind double 09-03: confirmed.
**Deep audit (2026-09-02, STEP 3 queue draw #4; blind double codex + claude-seat, both `AUDIT_HOLDS_CONSISTENCY_ONLY`; `bhu-acquisition-20260828/ENTRY10_RECONCILIATION_20260902.md`):** the Dirac axial-torsion source is reproduced and the Weyssenhoff closure of entry 9 is explicitly replaced by ⟨s²⟩ = (3/4)n² (line 113, uncited); k = 1 assumed (lines 134–137). The cusp bounce (ȧ jumps −v → +v, lines 287–290) is an artefact of the reduced system: it makes ä a δ-function against a bounded right-hand side of the paper's own eq. (12); no regulariser, no perturbation matching. T_cr = 0.78 m_P and a_cr = 5.9×10⁻⁴ m reproduce; eqs. (30)–(31), v_ant = 8.9×10³⁴ and Ω − 1 = 1.3×10⁻⁷⁰, do NOT (consistent recomputation: 2.8×10³¹ and 1.3×10⁻⁶²; the ratio 3,225 ≈ 1 + z_eq points to an a_r → a_0 substitution). No observation-facing quantity; not PROSPECT. **Tier UNCHANGED.** *(Cross-ref 2026-09-02: entry 53, lines 54–58, is the authors' own later statement that this cusp came from neglecting k = 1.)*
**RQ-B map (BHU Lane 2, 2026-09-01; Duho ruling q4 = annotate, keep tier):** The interior transfer function (parent -> torsion bounce -> daughter observable) is **UNDETERMINED by the published literature** -- the mechanism has field equations for the homogeneous BACKGROUND bounce but NO perturbation action; the closure is not fixed (a spin/number isocurvature mode gives delta-p_nad != 0), the bounce matching is undetermined (the PRD-85 realization is a cusp), and the particle-production constant beta is free. Poplawski himself states the density-fluctuation derivation "remains to be done." So the branch's falsifier question is genuinely OPEN (not closed by omission), needing an original linearized Einstein-Cartan perturbation action. Blind-double + independent third read (kimi): codex+kimi UNDETERMINED, agy NEW_FALSIFIER (outlier, assumed the adiabatic closure). **Tier UNCHANGED.** See `RQ_B_RECONCILIATION_20260901.md` + `RQ_B_kimi_CRUX_RESULT.md`.
...
**Study K3 step 1 (2026-09-03 19:34 KST; `bhu-acquisition-20260828/K3S1_RESULT_20260903.md`):** same finding for s² = ⅛(ℏcn_f)² (L84–85): a convention, not a derived average. **Gasperini source test (2026-09-04; `bhu-acquisition-20260828/GASPERINI_K3_RESULT_20260904.md`, check sheet, independent second seat):** the newly pinned cited source defines the same scalar and states the ⅛ relation without deriving its n² identification; `CONVENTION_CONFIRMED` 2/2. Warrant field only; token and tier untouched. **Ruled 2026-09-03 19:34 KST (Duho, typed into the lane pane, verbatim "as your rec" = option (a); provenance row pending Blanc confirmation).**
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_MIXED` — borrowed inputs: Papapetrou point-particle spin-fluid closure (SOURCE lines 67-75); random-spin averaging (SOURCE lines 82-83); unpolarized-spin relation s²=(ℏcn_f)²/8 (SOURCE lines 84-86); closed FLRW/black-hole-interior link (SOURCE lines 93-94, 121-122) Blind double 09-03: confirmed.
**Deep audit (2026-09-02, STEP 3 queue draw #1; blind double codex + claude-seat, both `AUDIT_HOLDS_CONSISTENCY_ONLY`; `bhu-acquisition-20260828/ENTRY11_RECONCILIATION_20260902.md`):** the bounce is derived within the closed spin-fluid FLRW ansatz (every printed number reproduces) on three cited-not-derived closures (Papapetrou spin fluid, random-spin averaging, s² = (ħc n_f)²/8); of the abstract's five adjectives only "nonsingular" is derived — "closed" is k = +1 written into the metric (line 93), homogeneity/isotropy are the ansatz, "nearly flat" is a bounce-epoch Ω_min − 1 never propagated to today; the exponential phase rests on a free β. Silent input: eq. (29)'s Ω_min − 1 = 5.7×10⁻³⁶ needs a_i ≈ 1 m, not the paper's "typical" 10⁴ m (which gives 5.7×10⁻⁴⁰); line 187's exponent should be −3/2. No observation-facing quantity; fluctuation spectrum deferred (line 364). **Tier UNCHANGED.**
**RQ-B map (BHU Lane 2, 2026-09-01; Duho ruling q4 = annotate, keep tier):** The interior transfer function (parent -> torsion bounce -> daughter observable) is **UNDETERMINED by the published literature** -- the mechanism has field equations for the homogeneous BACKGROUND bounce but NO perturbation action; the closure is not fixed (a spin/number isocurvature mode gives delta-p_nad != 0), the bounce matching is undetermined (the PRD-85 realization is a cusp), and the particle-production constant beta is free. Poplawski himself states the density-fluctuation derivation "remains to be done." So the branch's falsifier question is genuinely OPEN (not closed by omission), needing an original linearized Einstein-Cartan perturbation action. Blind-double + independent third read (kimi): codex+kimi UNDETERMINED, agy NEW_FALSIFIER (outlier, assumed the adiabatic closure). **Tier UNCHANGED.** See `RQ_B_RECONCILIATION_20260901.md` + `RQ_B_kimi_CRUX_RESULT.md`.
...
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_MIXED` — borrowed inputs: closed-slicing ansatz f(R) = −sin²R and r = a sin R (SOURCE lines 204–214); black-hole threshold from ref. [5] (SOURCE lines 240–244); inflation/data and interior-origin links from refs. [9–11] (SOURCE lines 320–325) Blind double 09-03: confirmed.
**Deep audit (2026-09-02, STEP 3 queue draw #9; blind double codex + kimi, both `AUDIT_HOLDS_CONSISTENCY_ONLY`; `bhu-acquisition-20260828/ENTRY12_RECONCILIATION_20260902.md`):** a compact TOS-form re-derivation of the 2010–2021 torsion-bounce line; k = +1 enters as the ansatz f(R) = −sin²R (line 209), not by derivation; no cusp treatment, no perturbation action; the rotating/inhomogeneous generalisation is an expectation (line 325). Turning-point threshold recomputed (prefactor 0.121, ~l_P²) but r₀ and M are never given. "Our Universe may be closed and born in the interior of a black hole" (lines 322–323) is the picture, not a derived observable. **Tier UNCHANGED.**
**RQ-B map (BHU Lane 2, 2026-09-01; Duho ruling q4 = annotate, keep tier):** The interior transfer function (parent -> torsion bounce -> daughter observable) is **UNDETERMINED by the published literature** -- the mechanism has field equations for the homogeneous BACKGROUND bounce but NO perturbation action; the closure is not fixed (a spin/number isocurvature mode gives delta-p_nad != 0), the bounce matching is undetermined (the PRD-85 realization is a cusp), and the particle-production constant beta is free. Poplawski himself states the density-fluctuation derivation "remains to be done." So the branch's falsifier question is genuinely OPEN (not closed by omission), needing an original linearized Einstein-Cartan perturbation action. Blind-double + independent third read (kimi): codex+kimi UNDETERMINED, agy NEW_FALSIFIER (outlier, assumed the adiabatic closure). **Tier UNCHANGED.** See `RQ_B_RECONCILIATION_20260901.md` + `RQ_B_kimi_CRUX_RESULT.md`.
...
**Inheritance from K3 step 1 (2026-09-03 19:34 KST):** the stiff torsion term this bounce uses carries the ⅛(ℏcn)² closure, now recorded as a convention (entries 9–11); the bounce's sign is unaffected, its scale rests on a chosen coefficient. Tier and token untouched. **Ruled 2026-09-03 19:34 KST (Duho, typed into the lane pane, verbatim "as your rec" = option (a); provenance row pending Blanc confirmation).**
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_MIXED` — borrowed inputs: macroscopic spin-fluid averaging and effective ECSK source (SOURCE lines 30–43, 76–83); closed homogeneous isotropic FLRW ansatz (SOURCE lines 63–70); equilibrium thermodynamics/SM degree counts (SOURCE lines 104–155); ΩR and a0 from WMAP plus ΩS from prior papers (SOURCE lines 181–212, 236–238) Blind double 09-03: confirmed.
...
**Sweep audit (blind-double, 2026-09-01; Duho-authorized via Blanc ~15:30):** codex + agy independently returned `TIER_CONFIRMED_CONSISTENCY_ONLY`. Every number classifies as internal-bounce (min scale factor a_bb=4.9×10⁻⁵ m; a_bb/a₀≈10⁻³²; Ω_Pl=5.5×10¹²²), above-Planck validity-limit (ε_bb=15.4 ε_Pl — the paper itself says this needs quantum gravity, `1105.6127:159`), borrowed-from-data (SM g≈100; Ω_R & a₀ from WMAP; Ω_S=−8.6×10⁻⁷⁰ from prior work), or hypothetical (g_f=10⁵ preons). The paper gives only homogeneous-**background** Friedmann + thermal-scaling equations — no perturbation action, mode equation, bounce transfer, or map to any CMB/relic/GW observable — so it conceals no calibrated falsifier and no directional prediction. Matches the RQ-B finding for the same torsion-bounce family (background yes, transfer no). **Tier UNCHANGED (CONSISTENCY-ONLY).** See `ENTRY39_RECONCILIATION_20260901.md`.
...
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_MIXED` — borrowed inputs: homogeneous closed-FLRW ansatz f(R)=-sin²R and r=a sin R (SOURCE lines 256-265); phenomenological particle-production law βH⁴ (SOURCE lines 346-349) Blind double 09-03: confirmed.
**Deep audit (2026-09-02, STEP 3 queue draw #18; blind double codex + kimi, both `AUDIT_HOLDS_CONSISTENCY_ONLY`; `bhu-acquisition-20260828/ENTRY40_DEEP_RECONCILIATION_20260902.md`):** the collapse is homogeneous and shear-free by construction — "Choosing f(R) = −sin²R" (line 191; eq. 23, line 260), the ansatz entry 12 inherits — so closure is chosen, not derived; with shear σ² ∼ a⁻⁶ a singularity forms (lines 340–344); inhomogeneous/rotating collapse conceded open (lines 416–419); bounce count and growth depend on the phenomenological β. "Could not be observed outside the black hole" (line 26). **The 2026-08-28 BLIND FLAG below is now ADJUDICATED: it does not survive** (A(a): assumed closure is not directional). **Tier UNCHANGED.**
...
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_MIXED` — borrowed inputs: closed Kantowski–Sachs characterization [KS; exact] (SOURCE lines 55–56); phenomenological particle-production law from prior work [ApJ] (SOURCE lines 362–368); external closure/anisotropy evidence (SOURCE lines 446–447) Blind double 09-03: confirmed.
**Deep audit (2026-09-02, STEP 3 queue draw #17; blind double codex + kimi, both `AUDIT_HOLDS_CONSISTENCY_ONLY`; `bhu-acquisition-20260828/ENTRY41_DEEP_RECONCILIATION_20260902.md`):** torsion-vs-shear is derived (σ² outgrows a⁻⁶, line 329; eq. 32 checks) and the rescue is a rate the author calls "phenomenologically given", (1/√−g)d(√−g n_f)/dt = βH⁴ (lines 362–364), with β free and its viable range only "if β is big enough" (line 408). **The 2026-08-28 BLIND FLAG below is now ADJUDICATED: it does not survive** — the Kantowski–Sachs map is derived, but "closed" is a cited KS property (line 56), the R × S² → S³ topology gap is unaddressed, and closure of OUR universe rests on asserted isotropisation and external evidence cited as motivation (lines 21, 446); in-model sign, not a derived prediction (A(a)). No number, no threshold. **Tier UNCHANGED.**
...
as with questions 1–4): **the tier stays CALIBRATED-FALSIFIER / LIVE — as an explicit convention
adopted AT this ruling, not by precedent.** My first closure claimed question 3 had already decided
"falsifier-claim-present → that tier leads"; CGATE_Q6 refuted that as a retrofit: **Q3 established
that the standing table can preserve claim-level scope; it did not decide priority between
calibrated and obstruction classes**, and its own record says *I* chose that option under Duho's
delegation — so "Duho already decided this shape" overstated the record twice. The convention now
stands on its own feet: *entry 51's paper-level label is its calibrated-falsifier claim; the
independently proved Papapetrou theorem is recorded as a scoped claim in prose and in the table row.*
*(AGATE's "an empirical falsifier is the higher-information label" is NOT
...
**The author's stated test is the LHC route**, verbatim: "Therefore the Large Hadron Collider (LHC), which can operate at energies up to ~10⁴ GeV, cannot produce micro black holes … if the four-dimensional ECKS theory is a correct theory of gravity." One-sided and positive-detection only: a confirmed black hole far below the ~10¹⁶ kg floor fires it; a null LHC search fires nothing. LIVE/unfired. **MEASUREMENT SIDE PINNED 2026-08-29** (+ **2026 receipts pinned 2026-09-01, freshness-confirmed**: ATLAS quantum-BH search `2604.19495` (Run-3, ~9.4 TeV) & PBH review `2601.06024` (asteroid-mass window incl. ~10¹⁶ kg still the only unconstrained PBH region) — both strengthen the null-search support; floor still LIVE/unfired. See `FALSIFIER_RECEIPTS_PIN_codex_20260901.md` + `FALSIFIER_FRESHNESS_codex_20260901.md`) — this previously read "CMS reports no
...
**Inheritance from K3 step 1 (2026-09-03 19:34 KST):** as entry 39 — the spin-fluid closure behind the threshold is a convention; sign unaffected, scale chosen. Tier and token untouched. **Ruled 2026-09-03 19:34 KST (Duho, typed into the lane pane, verbatim "as your rec" = option (a); provenance row pending Blanc confirmation).**
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_MIXED` — borrowed inputs: cited EC spin-fluid closure (SOURCE lines 35-46); ultrarelativistic equilibrium and Standard-Model state counts (SOURCE lines 111-113); assumed closed branch (SOURCE lines 134-136); Λ and T_eq inputs (SOURCE lines 408-412, 459-468) Blind double 09-03: confirmed.
...
**Inheritance from K3 step 1 (2026-09-03 19:34 KST):** as entry 39. Tier and token untouched. **Ruled 2026-09-03 19:34 KST (Duho, typed into the lane pane, verbatim "as your rec" = option (a); provenance row pending Blanc confirmation).**
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_MIXED` — borrowed inputs: homogeneous/isotropic FLRW assumption (SOURCE line 64); kinetic-equilibrium thermodynamics (SOURCE line 109); Planck-consistency result from SD (SOURCE line 39); black-hole-interior identification from BH (SOURCE lines 59–60) Blind double 09-03: confirmed.
**Deep audit (2026-09-02, STEP 3 queue draw #10; blind double codex + kimi, both `AUDIT_HOLDS_CONSISTENCY_ONLY`; `bhu-acquisition-20260828/ENTRY53_RECONCILIATION_20260902.md`):** same construction and threshold structure as entry 52 with a different coupling normalisation (threshold C > e^{−1/2}); k = 1 assumed (line 211); Table 1 reproduces to six figures (Tori recomputed C = 1: x_min 0.555209, y 2.10126, x_max 1.18912, y 1.70539). Its stated increment (lines 54–58): the earlier bounce calculation "neglected the factor k = 1 … de facto considering a flat universe" and "appeared to have a cusp-like behavior" — the authors' own attribution of entry 10's cusp to the dropped curvature term. Line 39 repeats 52's delegated CMB sentence (→ Desai & Popławski 2016, candidate). **Tier UNCHANGED.**
...
**Inheritance from K3 step 1 (2026-09-03 19:34 KST):** the torsion-bounce background solved here uses the ⅛ closure, now a recorded convention; the bounce's scale rests on a chosen coefficient. Tier and token untouched. **Ruled 2026-09-03 19:34 KST (Duho, typed into the lane pane, verbatim "as your rec" = option (a); provenance row pending Blanc confirmation).**
...
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_MIXED` — borrowed inputs: limiting-curvature hypothesis and de Sitter high-curvature core (SOURCE lines 193–211); Israel thin-shell method [5] (SOURCE lines 239–247); unspecified effective high-curvature equations/matter (SOURCE lines 189–211) Blind double 09-03: confirmed.
...
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_MIXED` (blind double 2026-09-03 14:10 KST: was `W_CONSTRUCTION_ASSERTED`; see `WARRANT_DOUBLE_RECONCILIATION_20260903.md`) — borrowed inputs: limiting-curvature hypothesis (SOURCE lines 199–225); de Sitter limiting form imposed as “our second main hypothesis” (SOURCE lines 231–249); Israel thin-shell method [9] (SOURCE lines 270–294)
...
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_CONSTRUCTION_ASSERTED` — borrowed inputs: limiting-curvature construction from ref. [3] (SOURCE lines 34–37) Blind double 09-03: confirmed.
...
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_MIXED` — borrowed inputs: Oppenheimer–Snyder–Datt collapse equations by citation (SOURCE lines 64–68); effective density ansatz from BMM (SOURCE lines 70–77); phase transition at the bounce imposed (SOURCE lines 59, 95–99); exactly Schwarzschild exterior assumed (SOURCE lines 55–56) Blind double 09-03: confirmed.
**Deep audit (2026-09-02, STEP 3 queue draw #8; blind double codex + kimi, both `AUDIT_HOLDS_CONSISTENCY_ONLY`; `bhu-acquisition-20260828/ENTRY17_RECONCILIATION_20260902.md`):** OSD dust with ρ_eff = ρ − ρ²/ρ_cr matched to an expanding FRW across the bounce (Darmois–Israel, smooth there); the surface layer sits at the interior–Schwarzschild junction, forced by the ASSUMPTION that the exterior stays Schwarzschild "at all times" (line 55) — so "no evidence of the bounce" at infinity (line 56) is an input, not a result. The phase transition is imposed: "the model does not describe the mechanism … does not predict what matter content would be allowed" (line 59); k_II, ω, m_II free. Interior observer: geometry only; no claim about OUR universe; Smolin merely "supported" (line 54). **Tier UNCHANGED.**
...
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_MIXED` (blind double 2026-09-03 14:10 KST: was `W_CONSTRUCTION_DERIVED`; see `WARRANT_DOUBLE_RECONCILIATION_20260903.md`) — borrowed inputs: Schwarzschild–Kruskal interior metric [13] (SOURCE lines 329–337); conformal-field/Hawking result [17] (SOURCE lines 399–408)
...
**Author field verified (2026-09-03 16:03 KST, Crossref):** A. Masó-Ferrando, N. Sanchis-Gual, J. A. Font & G. J. Olmo, JCAP 06 (2023) 028, DOI 10.1088/1475-7516/2023/06/028. (The 09-02 audit brief had guessed the lead author; corrected here.)
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_MIXED` (blind double 2026-09-03 14:10 KST: was `W_CONSTRUCTION_DERIVED`; see `WARRANT_DOUBLE_RECONCILIATION_20260903.md`) — borrowed inputs: unstable boson-star initial data from [42] (SOURCE line 56); chosen ξ=0.1, Φ₀=0.1, and 3% collapse perturbation (SOURCE line 56); Einstein-frame numerical method and prior implementation (SOURCE lines 54-56)
...
**Warrant (2026-09-03 15:52 KST, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_CONSTRUCTION_ASSERTED` (both blind seats, read against the 1992 GRG version of record `dymnikova_1992_grg24_235_vor_clean.txt`, pinned from Duho's library download 2026-09-03 15:52 KST) — borrowed inputs: assumed exponential stress-energy profile and de Sitter scale relation (SOURCE lines 118–127); Petrov-classification vacuum interpretation (SOURCE lines 73–85); standard mass formula (SOURCE lines 129–138). Original-vs-restatement (seats differ, token unaffected): codex — matches on the tier-bearing points (anisotropic vacuum source joining a de Sitter core to a Schwarzschild exterior); claude — The 2002 restatement does not match: it derives the class from energy conditions and demotes (8) to "The simplest choice". NO_TEXT status withdrawn; tier untouched. Finding for the record: the 1992 original makes no cosmological link at all; the variable-Λ cosmology reading entered with the 2002 restatement (arXiv gr-qc/0201058). Tier CONSISTENCY-ONLY holds either way.
...
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_MIXED` — borrowed inputs: previously constructed regular Λ-black-hole/de Sitter-core geometry (SOURCE lines 1153-1165); observed ΔT/T≤10⁻⁵ anisotropy bound (SOURCE lines 1118-1122) Blind double 09-03: confirmed.
**Deep audit (2026-09-02, STEP 3 queue draw #21, full text; blind double codex + claude-seat, both `AUDIT_HOLDS_CONSISTENCY_ONLY`; `bhu-acquisition-20260828/ENTRY19_DEEP_RECONCILIATION_20260902.md`):** the Λ-black-hole parent is imported; universe birth is a WKB tunnelling with a computed barrier (eqs. 13–18 re-derived); "favours a flat birth" (lines 1172–1176) is a parsimony statement, not a dynamical preference — the probability depends on k only through (k − B_s), fixed at ~10⁻⁶ by an IMPORTED ΔT/T ≤ 10⁻⁵ bound (lines 1118–1122) before k is chosen; the flat/open exclusion (barrier iff k − B_s > 0) is derived as stamped; our universe: "speculate (at least not exclude)" (lines 1178–1181). **Easson map (entry 22, Prop. 2): INAPPLICABLE** — daughters are wave functions never embedded as comoving FRW regions. **Tier UNCHANGED.**
...
**Full source pinned + re-confirmed 2026-09-01 (Duho ruling (a)):** the abridged browser capture is superseded by the full MDPI gold-OA PDF (`dymnikova_2019_universe{.pdf,_clean.txt}`, sha256 `2ddc3454`, fetched via INSPIRE by codex). Blind-double on the FULL text (codex + agy) re-confirms **CONSISTENCY-ONLY**: a Wheeler–DeWitt/WKB minisuperspace tunneling *consistency* argument; the de Sitter (positive-curvature) interior is an assumed premise and the model in fact favours a FLAT birth (`:1175`), so under A(a) it earns no directional uplift. Tier UNCHANGED. Receipts `dymnikova_2019_universe_clean.txt:825-878,1118-1181`.
...
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_MIXED` (blind double 2026-09-03 14:10 KST: was `W_CONSTRUCTION_DERIVED`; see `WARRANT_DOUBLE_RECONCILIATION_20260903.md`) — borrowed inputs: none
...
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_ROUTE_CONNECTED` — borrowed inputs: axial/polar isospectrality for ultracompact de Sitter-core objects from ref. [28] (SOURCE line 245); generalized Bohr–Sommerfeld method [30] and gravastar validation [31] (SOURCE lines 369–389); LISA sensitivity band (SOURCE line 399) Blind double 09-03: confirmed.
...
**Study K2 (2026-09-03 17:18 KST; `bhu-acquisition-20260828/K2_RESULT_20260903.md`):** Proposition 2's exclusion of shells loses nothing at Pathria's placement (the only shell there is unphysical); closed comoving daughters recollapse in an owned computation, confirming the closed limb. Domain (closed-daughter limb) and `W_PROOF_CITED` untouched. **Ruled 2026-09-03 17:18 KST (Duho, relay via Blanc 17:17 KST, verbatim "as Tori's rec, both a").**
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_PROOF_CITED` (blind double 2026-09-03 14:10 KST: was `W_PROOF_OWNED`; see `WARRANT_DOUBLE_RECONCILIATION_20260903.md`) — borrowed inputs: flat/open FRW completeness theorem (SOURCE lines 648–659, 887–901)
...
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_MIXED` — borrowed inputs: asymptotic de Sitter Laurent-series ansatz (SOURCE lines 1229-1237); tuned coherent-state parameters and free spin j (SOURCE lines 903-915, 969-978, 1002-1006); Planck-2018 baryonic-mass and observed-Λ inputs (SOURCE lines 1140-1144) Blind double 09-03: confirmed.
**Deep audit (2026-09-02, STEP 3 queue draw #20; blind double codex + claude-seat, both `AUDIT_HOLDS_CONSISTENCY_ONLY`; `bhu-acquisition-20260828/ENTRY55_DEEP_RECONCILIATION_20260902.md`):** the de Sitter interior is a posited asymptotic form made to solve the effective equations by fixing coherent-state parameters plus γ and ξ — "fine tuning" in the authors' words; the effective Λ ∝ 1/(ℓ_P² j) is free. γ ≈ 0.274 (eq. 60) vs the SU(2) entropy value 0.274067 is an a-posteriori three-figure consistency check with a second branch (0.227) present; not unique, not a prediction. Sec. VII's λ̄ ≃ 0.85×10⁻⁵² m⁻² vs 1.1×10⁻⁵² (line 1144) is conditional on an undelivered renormalisation and reduces to a flatness-type identity R_s(M_baryon) ∼ c/H₀ (claude-seat 0.8, Tori's check 1.6 with H₀ = 67.4 — order unity either way; breaks ×52 with total matter) — PROSPECT-adjacent prose, no owned number. **Tier UNCHANGED.**
...
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_DIRECTION_ASSUMED` (both blind seats; packet filed 2026-09-03 01:00) — the ~60° SCALE is derived non-circularly, but the suppression SIGN rests on the premise that causally disconnected regions carry no correlations (lines 89, 250–251, 435), i.e. the direction restated, not derived; borrowed: Ω_Λ from SNe/BAO (lines 330–336); no perturbation prescription (line 466). **Ruled 2026-09-03 01:1x KST (Duho, RELAY via pane, "a — keep tier, carry the warrant flag"): tier stays QUALITATIVE-DIRECTIONAL; W_DIRECTION_ASSUMED carried as a ruled flag, not a demotion.** Blind double 09-03: confirmed.
**Phase (b) map (2026-09-02; ruling delegated by Duho in direct chat — "i'm not the expert on this area so please ask to as various as models possible and decide on your own" — four-model blind poll codex/agy/kimi/claude-seat all `VOTE_A`; Tori's ruling `bhu-acquisition-20260828/INTERP_RULING_23_27_20260902.md`):** The 60° causal-horizon cutoff was tested like-for-like on the masked Planck SMICA map (pre-registered, controls passed, blind-doubled; `bhu-acquisition-20260828/PROGRAM_A_FREEDOM_MAP_20260902.md` §§1–2, 7, 9; `PHASEB_RESULT_RECONCILIATION_20260902.md`). **What the papers fix:** the angular scale, non-circularly — χ_§ from Ω_Λ measured by SNe/BAO, not from the correlation under test; 57.4°, rounded by the paper to 60±3 (the large-angle deficit itself was known before these papers, so this is a non-circular derivation, not an out-of-sample forecast). **What the papers do not fix:** the amplitude — **NOT CALIBRATABLE from the papers** (supersedes "NOT yet calibrated" in the RQ-C map): no perturbation prescription (READING_C ×3 + CLASS_REFUTED), and the author states that no initial-conditions model exists (2003.11544 L466, in context about observer-to-observer differences in the causal boundary). Under lane-built completions — exploratory, not calibration; non-exhaustive; amplitudes not attributable to the theory — every completion moved the observed-sky percentile upward in the predicted direction, from 0.15–0.2% (ΛCDM) to at best 2.2–2.8% (Reading A, 2π/χ_§), roughly 15×, and none lifts the observed sky above the ~3% level. Standing objection to the direction itself, carried open: absence of causal contact does not by itself imply zero correlation (common initial conditions can correlate disconnected regions). Open route — CLOSED 2026-09-02 (Program (C), ordered by Duho, `bhu-acquisition-20260828/PROGRAM_C_FLUX_RESULT_20260902.md`, four seats blind-agreed + numeric control): the paper's own Φ(χ>χ_§)=0 flux condition, imposed on the perturbed solution, constrains only the sky monopole when applied to our causal region (C_ℓ for ℓ ≥ 1 and S₁/₂ exactly unchanged) and admits no continuous power spectrum when applied to every observer; it is not the missing amplitude prescription. **Tier UNCHANGED (QUALITATIVE-DIRECTIONAL):** direction and scale a priori, amplitude unscorable; any threshold would be the lane's, recorded in the Program (A) write-up, not here.
...
signature (large-scale power cutoff / low quadrupole) whose amplitude the paper does not fix *(the
2026-08-19 triage wording "whose scale is fitted from the data it explains, not forecast ahead of it"
is superseded 2026-09-02: the scale chain is non-circular — χ_§ from Ω_Λ measured by SNe/BAO, freedom
map §1 — and what is unfixed is the amplitude; see the Phase (b) map above)*. Record: Phase 0 sweep territory; newly verified.
Audit-worthiness: **high** — see ranked target 3.

**24. E. Gaztañaga (2022). "A peek outside our Universe." Symmetry 14, 285.**
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_DIRECTION_DERIVED` (blind double 2026-09-03 14:10 KST: was `W_DIRECTION_ASSUMED`; see `WARRANT_DOUBLE_RECONCILIATION_20260903.md`) (follows entry 23 — same claim; codex's DERIVED on this entry refers to the scale projection) — junction and χ_§ cited from Gaztañaga 2021 (lines 119–140, 172–175); sky regions from Fosalba & Gaztañaga 2021 (lines 189–194). **Ruled 2026-09-03 01:1x KST (Duho, RELAY via pane, "a — keep tier, carry the warrant flag"): tier stays QUALITATIVE-DIRECTIONAL; W_DIRECTION_ASSUMED carried as a ruled flag, not a demotion.**
...
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_DIRECTION_ASSUMED` (PACKET — joined to the 23–27 question; the sign is the causal premise restated) — borrowed inputs: ΩΛ/background cosmology used to fix the finite causal scale (SOURCE lines 247–265); CMB-anomaly comparisons by citation (SOURCE lines 3126–3128) **Ruled 2026-09-03 01:1x KST (Duho, RELAY via pane, "a — keep tier, carry the warrant flag"): tier stays QUALITATIVE-DIRECTIONAL; W_DIRECTION_ASSUMED carried as a ruled flag, not a demotion.** Blind double 09-03: confirmed.
**Phase (b) map (2026-09-02; ruling delegated by Duho in direct chat — "i'm not the expert on this area so please ask to as various as models possible and decide on your own" — four-model blind poll codex/agy/kimi/claude-seat all `VOTE_A`; Tori's ruling `bhu-acquisition-20260828/INTERP_RULING_23_27_20260902.md`):** The 60° causal-horizon cutoff was tested like-for-like on the masked Planck SMICA map (pre-registered, controls passed, blind-doubled; `bhu-acquisition-20260828/PROGRAM_A_FREEDOM_MAP_20260902.md` §§1–2, 7, 9; `PHASEB_RESULT_RECONCILIATION_20260902.md`). **What the papers fix:** the angular scale, non-circularly — χ_§ from Ω_Λ measured by SNe/BAO, not from the correlation under test; 57.4°, rounded by the paper to 60±3 (the large-angle deficit itself was known before these papers, so this is a non-circular derivation, not an out-of-sample forecast). **What the papers do not fix:** the amplitude — **NOT CALIBRATABLE from the papers** (supersedes "NOT yet calibrated" in the RQ-C map): no perturbation prescription (READING_C ×3 + CLASS_REFUTED), and the author states that no initial-conditions model exists (2003.11544 L466, in context about observer-to-observer differences in the causal boundary). Under lane-built completions — exploratory, not calibration; non-exhaustive; amplitudes not attributable to the theory — every completion moved the observed-sky percentile upward in the predicted direction, from 0.15–0.2% (ΛCDM) to at best 2.2–2.8% (Reading A, 2π/χ_§), roughly 15×, and none lifts the observed sky above the ~3% level. Standing objection to the direction itself, carried open: absence of causal contact does not by itself imply zero correlation (common initial conditions can correlate disconnected regions). Open route — CLOSED 2026-09-02 (Program (C), ordered by Duho, `bhu-acquisition-20260828/PROGRAM_C_FLUX_RESULT_20260902.md`, four seats blind-agreed + numeric control): the paper's own Φ(χ>χ_§)=0 flux condition, imposed on the perturbed solution, constrains only the sky monopole when applied to our causal region (C_ℓ for ℓ ≥ 1 and S₁/₂ exactly unchanged) and admits no continuous power spectrum when applied to every observer; it is not the missing amplitude prescription. **Tier UNCHANGED (QUALITATIVE-DIRECTIONAL):** direction and scale a priori, amplitude unscorable; any threshold would be the lane's, recorded in the Program (A) write-up, not here.
...
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_DIRECTION_DERIVED` (blind double 2026-09-03 14:10 KST: was `W_DIRECTION_ASSUMED`; see `WARRANT_DOUBLE_RECONCILIATION_20260903.md`) (PACKET — joined to the 23–27 question; the sign is the causal premise restated) — borrowed inputs: finite-cloud BHU background from Part I (SOURCE lines 75–79); gravitational-instability results [32–34] (SOURCE lines 987–1010); measured cutoff/anomaly literature [12,35,39–43] (SOURCE lines 1010, 1513–1516) **Ruled 2026-09-03 01:1x KST (Duho, RELAY via pane, "a — keep tier, carry the warrant flag"): tier stays QUALITATIVE-DIRECTIONAL; W_DIRECTION_ASSUMED carried as a ruled flag, not a demotion.**
**Phase (b) map (2026-09-02; ruling delegated by Duho in direct chat — "i'm not the expert on this area so please ask to as various as models possible and decide on your own" — four-model blind poll codex/agy/kimi/claude-seat all `VOTE_A`; Tori's ruling `bhu-acquisition-20260828/INTERP_RULING_23_27_20260902.md`):** The 60° causal-horizon cutoff was tested like-for-like on the masked Planck SMICA map (pre-registered, controls passed, blind-doubled; `bhu-acquisition-20260828/PROGRAM_A_FREEDOM_MAP_20260902.md` §§1–2, 7, 9; `PHASEB_RESULT_RECONCILIATION_20260902.md`). **What the papers fix:** the angular scale, non-circularly — χ_§ from Ω_Λ measured by SNe/BAO, not from the correlation under test; 57.4°, rounded by the paper to 60±3 (the large-angle deficit itself was known before these papers, so this is a non-circular derivation, not an out-of-sample forecast). **What the papers do not fix:** the amplitude — **NOT CALIBRATABLE from the papers** (supersedes "NOT yet calibrated" in the RQ-C map): no perturbation prescription (READING_C ×3 + CLASS_REFUTED), and the author states that no initial-conditions model exists (2003.11544 L466, in context about observer-to-observer differences in the causal boundary). Under lane-built completions — exploratory, not calibration; non-exhaustive; amplitudes not attributable to the theory — every completion moved the observed-sky percentile upward in the predicted direction, from 0.15–0.2% (ΛCDM) to at best 2.2–2.8% (Reading A, 2π/χ_§), roughly 15×, and none lifts the observed sky above the ~3% level. Standing objection to the direction itself, carried open: absence of causal contact does not by itself imply zero correlation (common initial conditions can correlate disconnected regions). Open route — CLOSED 2026-09-02 (Program (C), ordered by Duho, `bhu-acquisition-20260828/PROGRAM_C_FLUX_RESULT_20260902.md`, four seats blind-agreed + numeric control): the paper's own Φ(χ>χ_§)=0 flux condition, imposed on the perturbed solution, constrains only the sky monopole when applied to our causal region (C_ℓ for ℓ ≥ 1 and S₁/₂ exactly unchanged) and admits no continuous power spectrum when applied to every observer; it is not the missing amplitude prescription. **Tier UNCHANGED (QUALITATIVE-DIRECTIONAL):** direction and scale a priori, amplitude unscorable; any threshold would be the lane's, recorded in the Program (A) write-up, not here.
**RQ-C map (BHU Lane 2, 2026-08-31; Duho ruling q3 = annotate, keep tier):** The causal-horizon power-spectrum cutoff is a PREDICTED (out-of-sample), Planck-consistent, **scale-level CMB falsifier CANDIDATE** -- l_cut = 3 / theta = 60 deg, fixed from background H0/Omega_Lambda (r_S=2GM), no free parameter, published BEFORE the CMB analysis; consistent with Planck's low quadrupole + the >60 deg S_1/2 large-angle deficit (both seats agree). NOT yet calibrated: the papers supply no cutoff amplitude / C_l threshold (the model owns that missing proof). **Tier UNCHANGED (QUALITATIVE-DIRECTIONAL).** See `RQ_C_RECONCILIATION_20260831.md`.
...
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_DIRECTION_ASSUMED` (PACKET — joined to the 23–27 question; the sign is the causal premise restated) — borrowed inputs: Ωm, ΩΛ, and H0 background normalization (SOURCE lines 210–224); observed CMB homogeneity scale ΘH = 66 ± 9° (SOURCE lines 302–303) **Ruled 2026-09-03 01:1x KST (Duho, RELAY via pane, "a — keep tier, carry the warrant flag"): tier stays QUALITATIVE-DIRECTIONAL; W_DIRECTION_ASSUMED carried as a ruled flag, not a demotion.** Blind double 09-03: confirmed.
**Deep audit (2026-09-02, STEP 3 of Duho's "a → b → c"; blind double codex + claude-seat, both `AUDIT_HOLDS_QUALITATIVE_DIRECTIONAL`; `bhu-acquisition-20260828/ENTRY27_RECONCILIATION_20260902.md`):** the finite cloud radius R(τ) is derived (Eq. 11, Appendix A) and fixed non-circularly from (Ω_m, Ω_Λ, H₀); the spectral cutoff "k < π/R" (line 295) is asserted in prose, not derived — the 09-01 sweep's "derives" is superseded by "restates". Entry 27 does fix the Fourier convention entry 23 left free, and it is the **2π/χ_§** one: k_cut = π/(R/a) ≈ 4.3–4.7×10⁻⁴ Mpc⁻¹ vs 2π/χ_§ = 4.48×10⁻⁴ — i.e. phase (b)'s most favourable row (2.2–2.8%), not the π/χ_§ row. No amplitude, statistic or threshold is stated (author: perturbations still to be estimated, lines 329–334, 339); Θ_H = 66 ± 9° is the author's own 2021 measurement compared to, not a forecast. **Tier UNCHANGED.** Side note: Eq. 9's printed r_S ≃ 6×10²² km disagrees with 2GM/c² for its own M by ~2.5× (does not enter the angle).
**Phase (b) map (2026-09-02; ruling delegated by Duho in direct chat — "i'm not the expert on this area so please ask to as various as models possible and decide on your own" — four-model blind poll codex/agy/kimi/claude-seat all `VOTE_A`; Tori's ruling `bhu-acquisition-20260828/INTERP_RULING_23_27_20260902.md`):** The 60° causal-horizon cutoff was tested like-for-like on the masked Planck SMICA map (pre-registered, controls passed, blind-doubled; `bhu-acquisition-20260828/PROGRAM_A_FREEDOM_MAP_20260902.md` §§1–2, 7, 9; `PHASEB_RESULT_RECONCILIATION_20260902.md`). **What the papers fix:** the angular scale, non-circularly — χ_§ from Ω_Λ measured by SNe/BAO, not from the correlation under test; 57.4°, rounded by the paper to 60±3 (the large-angle deficit itself was known before these papers, so this is a non-circular derivation, not an out-of-sample forecast). **What the papers do not fix:** the amplitude — **NOT CALIBRATABLE from the papers** (supersedes "NOT yet calibrated" in the RQ-C map): no perturbation prescription (READING_C ×3 + CLASS_REFUTED), and the author states that no initial-conditions model exists (2003.11544 L466, in context about observer-to-observer differences in the causal boundary). Under lane-built completions — exploratory, not calibration; non-exhaustive; amplitudes not attributable to the theory — every completion moved the observed-sky percentile upward in the predicted direction, from 0.15–0.2% (ΛCDM) to at best 2.2–2.8% (Reading A, 2π/χ_§), roughly 15×, and none lifts the observed sky above the ~3% level. Standing objection to the direction itself, carried open: absence of causal contact does not by itself imply zero correlation (common initial conditions can correlate disconnected regions). Open route — CLOSED 2026-09-02 (Program (C), ordered by Duho, `bhu-acquisition-20260828/PROGRAM_C_FLUX_RESULT_20260902.md`, four seats blind-agreed + numeric control): the paper's own Φ(χ>χ_§)=0 flux condition, imposed on the perturbed solution, constrains only the sky monopole when applied to our causal region (C_ℓ for ℓ ≥ 1 and S₁/₂ exactly unchanged) and admits no continuous power spectrum when applied to every observer; it is not the missing amplitude prescription. **Tier UNCHANGED (QUALITATIVE-DIRECTIONAL):** direction and scale a priori, amplitude unscorable; any threshold would be the lane's, recorded in the Program (A) write-up, not here.
...
**Study K2 (2026-09-03 17:18 KST; `bhu-acquisition-20260828/K2_RESULT_20260903.md`):** the borrowed "empty-exterior boundary closure" is DERIVED — the finite top-hat joins its empty exterior as a smooth comoving Oppenheimer–Snyder junction ([K_ab] = 0, M = 4/3 π χ*³ ρ₀ at its L143), expanding forever for k = 0. The `W_DIRECTION_ASSUMED` token is untouched (the cut-off direction is a separate claim). **Ruled 2026-09-03 17:18 KST (Duho, relay via Blanc 17:17 KST, verbatim "as Tori's rec, both a").**
**Warrant (2026-09-03 15:44 KST, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_DIRECTION_ASSUMED` (both blind seats: the cut-off direction is a premise/citation, no perturbation derivation; the letter declines the non-flat case at source lines 138–141) — borrowed inputs: finite top-hat and empty-exterior boundary closure (SOURCE lines 147–160); GHY boundary evaluation from Gaztañaga (2022c) (SOURCE lines 206–218); reported CMB cut-off measurements from Fosalba & Gaztañaga (2021) and Gaztañaga & Camacho-Quevedo (2022) (SOURCE lines 268–271). Text pinned today from the already-pinned MNRAS PDF (`gaztanaga_mass_mnras_clean.txt`); NO_TEXT status withdrawn. **Ruled 2026-09-03 16:12 KST (Duho, relay via Blanc 16:11 KST, verbatim "as Tori's rec" = option (a)): tier QUALITATIVE-DIRECTIONAL kept; `W_DIRECTION_ASSUMED` carried as a ruled flag, extending the 01:10 ruling.**
...
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_DIRECTION_DERIVED` — borrowed inputs: homogeneous finite spherical-cloud assumption and closed-overdensity setup (SOURCE lines 125–152); ground-state effective density used in the Friedmann equation (SOURCE lines 270–282) Blind double 09-03: confirmed.
...
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_MIXED` (blind double 2026-09-03 14:10 KST: was `W_CONSTRUCTION_DERIVED`; see `WARRANT_DOUBLE_RECONCILIATION_20260903.md`) — borrowed inputs: critical flat-FRW interior and radiation equation of state (SOURCE lines 90-110); observed H₀ and microwave-background T₀ (SOURCE lines 3138-3185); free model start epoch R* (SOURCE lines 160-167)
...
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_MIXED` (blind double 2026-09-03 14:10 KST: was `W_CONSTRUCTION_DERIVED`; see `WARRANT_DOUBLE_RECONCILIATION_20260903.md`) — borrowed inputs: none
**Deep audit (2026-09-02, STEP 3 queue draw #3; blind double codex + claude-seat, both `AUDIT_HOLDS_CONSISTENCY_ONLY`; `bhu-acquisition-20260828/ENTRY37_RECONCILIATION_20260902.md`):** Theorems 1–3 and the t₀ bounds (within 4.5 Hubble lengths; white-hole exit by 4.5 t₀) are proved within stated hypotheses; the shock's distance is one free parameter (lines 296–297); the only observation-facing sentence — thermalization "well beyond the light cone" without inflation (lines 43–44) — is deferred at once to the forthcoming paper [8] = entry 38, and rests on the FRW ansatz. **The 2026-08-28 BLIND FLAG below is now ADJUDICATED: it does not survive** — every derived direction is model-internal (entropy condition imposed by hypothesis; weakening shock, white-hole exit, interior mass function never mapped to an observable; the "visibility" epoch is an infinite-redshift image behind last scattering). Not PROSPECT either: reaching an observation needs the lane to supply physics, not a threshold. **Tier UNCHANGED.**
...
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_MIXED` — borrowed inputs: foundational Lipschitz-matching and junction theorems from earlier work [7] (SOURCE lines 393–553); big-bang shock scenario from prior exact solution [8] (SOURCE lines 53–60); prescribed equations of state and free initial data (SOURCE lines 35–49, 1755–1774) Blind double 09-03: confirmed.
...
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_ROUTE_CONNECTED` — borrowed inputs: spherical simultaneous-nucleation model and light-speed walls (SOURCE lines 67–69, 93–100); Birkhoff theorem (SOURCE lines 99–111); constant quantum nucleation rate (SOURCE lines 163–170); flat-space percolation threshold and typical-domain estimate (SOURCE lines 187–201, 218–226); 60-expansion-time homogeneity condition (SOURCE lines 207–214); assumption that all false-vacuum domains become wormh Blind double 09-03: confirmed.
**Deep audit (2026-09-02, STEP 3 queue draw #24; blind double codex + claude-seat, both `AUDIT_HOLDS_PROSPECT`; `bhu-acquisition-20260828/ENTRY47_DEEP_RECONCILIATION_20260902.md`):** the ~10⁷⁷ count is derived but is a floor at ν = 1/60 (e^{3N}, geometry cancels) resting on the unproved "all trapped domains become wormholes"; the child-radius check (eq. 18, ≈ 10 cm × 10²⁸) only ALLOWS our universe to be a child; the n_B/s remark (lines 347–353) carries a sign but no factor or inequality and is disowned in the next sentence — a calculable route (lane illustration 10⁶–10¹⁰ dilution) whose NUMBER the lane may not supply. **Tier UNCHANGED.**
...
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_PROOF_OWNED` — borrowed inputs: Penrose singularity theorem [7] (SOURCE lines 230–246, 507) Blind double 09-03: confirmed.
...
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_MIXED` (blind double 2026-09-03 14:10 KST: was `W_CONSTRUCTION_DERIVED`; see `WARRANT_DOUBLE_RECONCILIATION_20260903.md`) — borrowed inputs: exact spherical symmetry and equilibrium thin-wall approximation (SOURCE lines 127–140); Birkhoff theorem and regular de Sitter center (SOURCE lines 149–158); positive false-vacuum density, wall tension, and chosen initial trajectory (SOURCE lines 251–264, 527–575)
...
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_MIXED` — borrowed inputs: classical false-vacuum bubble trajectories and entry-48 singularity result reviewed with citations (SOURCE lines 190–208); semiclassical WKB/action formalism (SOURCE lines 205–219, 748–752) Blind double 09-03: confirmed.
...
**Study K2 (2026-09-03 17:18 KST; `bhu-acquisition-20260828/K2_RESULT_20260903.md`):** the shell this paper derives (μ = 0, p = ρa/4) is reproduced by two blind seats and fails the dominant energy condition, so "shell-bearing realizations … not excluded" closes at this placement: unphysical. A no-shell dust boundary exists iff comoving (theorem). Tier and token untouched. **Ruled 2026-09-03 17:18 KST (Duho, relay via Blanc 17:17 KST, verbatim "as Tori's rec, both a").**
**Warrant (2026-09-03, corpus-wide warrant audit; `bhu-acquisition-20260828/WARRANT_TABLE_20260903.md`):** `W_PROOF_OWNED` — borrowed inputs: Barrabès–Israel null-shell formalism (SOURCE lines 49-55, 137-140) Blind double 09-03: confirmed.
