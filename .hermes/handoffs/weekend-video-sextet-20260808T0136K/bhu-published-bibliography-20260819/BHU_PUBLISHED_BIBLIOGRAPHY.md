...
**Study K1 stage 1 (2026-09-03 17:18 KST; `bhu-acquisition-20260828/K1S1_RESULT_20260903.md`):** the premise under the 2.5 M☉ bar (a local maximum of black-hole production) fails for the primordial amplitude in a semi-analytic model with a declared nuisance box; Rothman & Ellis's "primary requirement" is answered without needing primordial black holes (their channel is empty at the Planck amplitude). Standing LIVE and tier untouched; the falsifier still tests what Smolin stated. Stage 2 (population synthesis) preregistered next. **Ruled 2026-09-03 17:18 KST (Duho, relay via Blanc 17:17 KST, verbatim "as Tori's rec, both a").**
...
**Inheritance from K3 step 1 (2026-09-03 19:34 KST):** the torsion-bounce background solved here uses the ⅛ closure, now a recorded convention; the deferred torsion spectrum would inherit the coefficient choice. Tier and token untouched. **Ruled 2026-09-03 19:34 KST (Duho, typed into the lane pane, verbatim "as your rec" = option (a); provenance row pending Blanc confirmation).**
