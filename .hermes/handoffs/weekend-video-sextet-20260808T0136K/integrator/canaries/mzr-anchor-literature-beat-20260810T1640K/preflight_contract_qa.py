...
def main() -> int:
    ...
    checks["quotes_exact_in_lana_ruling"] = all(q in lana for q in config["quotes"])
    ...
    checks["new_versioned_filename"] = spec["candidate_filename"] != base["candidate_filename"] and "literature-beat-canary-20260810T1640K" in spec["candidate_filename"]
