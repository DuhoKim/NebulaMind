#!/usr/bin/env python3
"""Deterministic method-only figures for the spin-parity visual canary, v2.
...
plt.rcParams.update({
    ...
    "font.family": "Arial", "svg.hashsalt": "spin-method-canary-v2",
})
...
fig.text(0.015, 0.085, acct, fontsize=12.5, color=DIM)
fig.text(0.015, 0.048,
