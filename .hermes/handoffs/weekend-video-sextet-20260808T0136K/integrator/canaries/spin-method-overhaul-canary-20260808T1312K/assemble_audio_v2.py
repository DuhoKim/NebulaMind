#!/usr/bin/env python3
"""Derive the corrected visual timeline from freshly decoded v2 sentence audio."""
...
SRT = ROOT / "spin-method-overhaul-canary-20260808T1312K-v2.srt"
SAMPLE_RATE = 48_000
TARGET_WPM = 115.0
LEAD_SECONDS = 0.6
TAIL_SECONDS = 2.4
BASE_PAUSE_SECONDS = 0.75
SECTION_GAPS_AFTER = {"s02", "s05", "s10", "s11", "s13", "s16", "s18", "s21"}
