...
def main() -> int:
    ...
    checks = {
        ...
        "all_24_sentence_frames_nonblack": len(frame_stats) >= 24 and all(item["mean_luma"] > 8 for item in frame_stats[:24]),
        ...
        "v1_audio_still_preserved": sha256(ROOT / "audio" / "narration_master.wav") == "ef28bc8f290a46e59b0a2875fed076711666f37024d06e2cd5c986712eb4cd04",
    }
    report = {
        "candidate": ROOT.name,
