#!/usr/bin/env python3
"""Synthesize narrative v3 one exact sentence per managed OpenAI TTS call.

This introduction lineage never reads or reuses predecessor audio.
"""
...
RAW_DIR = ROOT / "audio_v3" / "raw"
RECEIPT_PATH = ROOT / "audio_v3" / "synthesis_receipt.json"
MODEL = "gpt-4o-mini-tts"
VOICE = "alloy"
SPEED = 1.18
INSTRUCTIONS = (
    "Measured scientific-conference narration. Calm, precise, and authoritative. "
    "Give the four-sentence opening scientific motivation warmth and clarity without implying a result. "
...
def main() -> int:
    ...
    receipt = {
        ...
        "predecessor_audio_not_reused": "spin-method-overhaul-canary-20260808T1312K/audio_v2/",
