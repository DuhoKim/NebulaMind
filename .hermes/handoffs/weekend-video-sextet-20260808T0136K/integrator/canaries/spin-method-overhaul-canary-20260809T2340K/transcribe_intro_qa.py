#!/usr/bin/env python3
"""Transcribe the encoded six-sentence why-study introduction through the managed audio gateway."""
...
INTRO_WAV = OUT_DIR / "encoded-why-study-introduction-v4.wav"
REPORT = OUT_DIR / "encoded-why-study-introduction-transcription-v4.json"
...
def main() -> int:
    ...
    if [item["id"] for item in opening] != ["i01", "i02", "i03", "i04", "i05", "i06"]:
    ...
    required = {
        ...
        "open_question": all(term in transcript_norm for term in ("left unsettled", "adopts no answer")),
