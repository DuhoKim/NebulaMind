#!/usr/bin/env python3
"""Fail-closed encoded QA for the frozen V12 candidate."""
...
VIDEO = Path("/Users/duhokim/HermesOps/cockpit/videos/bhu-closing-record-v12-local-20260813T1657K.mp4")
SIDE_SRT = Path("/Users/duhokim/HermesOps/cockpit/videos/bhu-closing-record-v12-captions-20260813T1657K.srt")
SIDE_VTT = Path("/Users/duhokim/HermesOps/cockpit/videos/bhu-closing-record-v12-captions-20260813T1657K.vtt")
...
TEXT_CONTRACT = SOURCE / "V12_VISUAL_TEXT_CONTRACT.json"
...
REPORT_JSON = QA_DIR / "V12_ENCODED_QA.json"
REPORT_MD = QA_DIR / "V12_ENCODED_QA.md"
EXPECTED = {
    "video": "060764c04ba095637cb484237064d501e097b1c326d7bf8b389a22292f96d9c2",
    "story": "9d55257fe62c7a82d2fe32f424e896ce079393219c08aed6663b6c90c3539399",
    "narration": "178ffe4ada125668c8ff84bc156adee7820954591f9781adb7101aac562d80da",
    "text_contract": "c91662e15de095161e84d128683dd69150c8a73b4cbb6f303dda8f79c943999c",
    ...
    "renderer": "f1747aa19472cca2810e4465572eaeecc99ce620b4b97e9a0e8d9bed9fdcee1d",
}
BANNED_VIEWER_TEXT = [
...
def main() -> int:
    ...
    paths = {"video": VIDEO, "story": STORY, "narration": NARRATION, "text_contract": TEXT_CONTRACT, "spec": SPEC,
    ...
    checks.append(check("lana_wpm_band_and_design_point", all(135 <= value <= 150 and abs(value-142.0) <= 0.02 for value in card_wpms), {"card_wpms": card_wpms, "band": [135,150], "design_point": 142.0}))
    ...
    status = "PASS_V12_ENCODED_QA_READY_FOR_THREE_SEAT_VISUAL_GATE" if not failed else "HOLD_V12_ENCODED_QA"
    report = {
        ...
        "three_seat_gate": "NOT_RUN_BY_THIS_QA",
    }
    REPORT_JSON.write_text(json.dumps(report, indent=2, ensure_ascii=False) + "\n")
    lines = [f"# V12 encoded QA — {status}", "", f"- Candidate: `{VIDEO}`", f"- SHA-256: `{report['candidate_sha256']}`", f"- Checks: {report['checks_passed']}/{report['checks_total']} PASS", f"- Embedded subtitle stream: asserted, extracted, and payload/timing checked", f"- Three-seat gate: not run here", f"- YouTube caption serving: separate post-upload gate; not inferred", "", "## Checks", ""]
