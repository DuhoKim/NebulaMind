#!/usr/bin/env python3
"""Instrument all V12 text-drawing calls against Lana's closed-world keep lists."""
...
RENDERER_PATH = ROOT / "render_v12.py"
OUTPUT = ROOT / "V12_RENDERED_TEXT_PROJECTION_AUDIT.json"


def load_renderer():
    spec = importlib.util.spec_from_file_location("render_v12_for_text_audit", RENDERER_PATH)
    if spec is None or spec.loader is None:
        raise RuntimeError("could not load V12 renderer")
