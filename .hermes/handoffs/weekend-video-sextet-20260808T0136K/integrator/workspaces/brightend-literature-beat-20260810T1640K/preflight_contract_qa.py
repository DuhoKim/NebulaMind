...
def main() -> int:
    ...
    checks["symbol_complete_serif_for_unicode_quote"] = lane != "brightend" or (next(r for r in records if r["id"] == "i05b")["params"].get("serif_font") == "New York" and "NewYork.ttf" in renderer)
