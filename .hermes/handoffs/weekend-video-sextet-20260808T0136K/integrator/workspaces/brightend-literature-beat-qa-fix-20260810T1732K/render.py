...
SERIF_SYMBOL_PATH = "/System/Library/Fonts/NewYork.ttf"
...
class Renderer:
    ...
    def validate(self):
        ...
        def caption_font(record):
            ...
            return font(size,serif=True,serif_symbol=record.get("params",{}).get("serif_font")=="New York")
    ...
    def literature(self,draw,r,p,t):
        ...
        wrapped(draw,r["text"],(385,420,1535,625),P.get("quote_font_size",32),WHITE,max_lines=6,serif=True,serif_symbol=P.get("serif_font")=="New York")
    ...
    def frame(self,t):
        ...
        rounded(draw,(170,940,1750,1054),22,(5,12,23),GRID,2); wrapped(draw,r["text"],(205,958,1715,1038),caption_size,WHITE,bold=visual!="literature",max_lines=2,serif=visual=="literature",serif_symbol=r.get("params",{}).get("serif_font")=="New York")
        return img
