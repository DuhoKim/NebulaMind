...
\mathrm{}{G Z2_{F e a t u r e s O r D i s k}>0.7~\ \mathrm{A N D}~G Z2_{N o t E d g e O n}>0.7~\mathrm{A N D}~G Z2_{s p i r a l}>0.5}
...
P_{S}+P_{Z} to be correlated with chirality, in addition to several SpArcFiRe outputs with all chirality
information removed.
...
((\ P_{S}\ +\ P_{Z}\:>\:0.6)\ cap(\ P_{S}\:>\:0.5)\ \cap\ (P_{S}\:-\:P_{Z}\:>\:0.3))
