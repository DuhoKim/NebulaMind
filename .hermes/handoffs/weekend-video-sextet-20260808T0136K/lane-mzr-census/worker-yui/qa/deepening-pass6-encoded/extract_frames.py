...
sheet.save(OUT / "contact_sheet_32frames_offset3.jpg", quality=94, subsampling=0)
print(f"extracted={len(TIMES)} contact_sheet={OUT / 'contact_sheet_32frames_offset3.jpg'}")
