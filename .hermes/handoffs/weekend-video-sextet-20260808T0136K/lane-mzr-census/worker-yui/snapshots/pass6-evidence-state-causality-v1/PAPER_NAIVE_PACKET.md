# Paper-naive closed-book packet — MZR archive census pass-6 v1 proposal
...
Only audience-visible copy is included below. Build directions, timed reveal states, verification filenames, source paths, prior verdicts, and the answer key are excluded.
