# Exact review-packet scope — pass-7 v9
...
- Exact v8 storyboard, complete-audience projection over narration/screen/citations, neutral-question audience packet, proposal validation, approved contract, validator, preparers, mutation suite, and v9 local-check receipt.
...
- Static-v9 proposal and its snapshot-local renderer/full-resolution QA; earlier visuals are excluded from current acceptance.
