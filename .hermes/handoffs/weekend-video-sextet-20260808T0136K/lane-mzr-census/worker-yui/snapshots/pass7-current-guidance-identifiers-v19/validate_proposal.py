...
if semantic_mutation_harness:
    ...
    entry_checks = {
        relative: (HERE / relative).is_file()
...
approved_contract_checks = {
    "storyboard_version_exact": storyboard.get("storyboard_version") == approved_contract["storyboard_version"] == "pass7-qualified-precision-version-v18",
