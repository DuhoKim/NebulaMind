# Exact review-packet scope — pass-7 v8
...
- Exact v8 storyboard, neutral-question audience packet, proposal validation, approved contract, validator, preparers, mutation suite, and v8 local-check receipt.
...
- Static-v8 proposal and its renderer/QA.
...
- Prior paper-naive and adversarial answer/result artifacts, including v1–v7 review outputs, so the closed-book packet contains no review answer key.
