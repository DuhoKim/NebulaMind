...
packet_version = "pass7-exhaustive-receipt-and-neutral-scaffolding-v27"
...
questions = [
    ...
    "Reconstruct the quantitative progression and explain how it connects to pending workflow work.",
    "Explain the highlighted side-check result and its non-implications.",
    "Compare the available evidence, design, and current status.",
    "Explain what the recorded checks established and left unresolved.",
    "Describe and name the recorded example taxonomy.",
    "Separate what the packet supports reporting now from what remains pending.",
]
approved_questions_sha256 = "eae490f5e1b4b7e7d3334e1805cf2eebf66fcfd15eddae0ddb6cf2dcc078b9ec"
...
structural_premise_fragments = ("next workflow stage", "across workflow stages", "each group")
structural_premise_hits = {
    fragment: [question for question in questions if fragment.lower() in question.lower()]
    for fragment in structural_premise_fragments
}
assert all(not hits for hits in structural_premise_hits.values())
lines = [
...
receipt = {
    ...
    "review_scaffolding": {
        ...
        "questions_supply_avoidable_structural_premises": False,
        ...
        "structural_premise_hits": structural_premise_hits,
    },
