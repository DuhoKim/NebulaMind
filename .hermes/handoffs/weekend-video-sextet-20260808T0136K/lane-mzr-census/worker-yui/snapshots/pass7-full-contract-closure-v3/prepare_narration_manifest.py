...
manifest = {
    ...
    "integration_constraints": [
        ...
        "No substantive scientific evidence state may remain unchanged for more than four seconds on the global timeline; every declared narration clause must map to at least one structured reveal or transform state.",
