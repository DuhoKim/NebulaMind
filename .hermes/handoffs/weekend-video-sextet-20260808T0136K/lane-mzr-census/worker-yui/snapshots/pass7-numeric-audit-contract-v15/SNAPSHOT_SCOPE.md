# Exact review-packet scope — pass-7 v15
...
- Exact v13 external-anchor storyboard contract with unchanged v8 audience/build semantics, complete-audience projection over narration/screen/citations, canonical-hash-pinned neutral questions, proposal validation, approved contract, full-inventory manifest validator, visual-v9-authenticating preparers, numeric-audit contract, mutation suite, and v15 local-check receipt.
