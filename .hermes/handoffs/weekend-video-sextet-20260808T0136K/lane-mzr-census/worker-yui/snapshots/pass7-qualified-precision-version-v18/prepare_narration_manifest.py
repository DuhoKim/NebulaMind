...
assert visual_qa["accepted_artifact"] == "visual_proposal_v9.png"
visual_path = HERE / visual_qa["accepted_artifact"]
assert visual_path.is_file()
assert hashlib.sha256(visual_path.read_bytes()).hexdigest() == visual_qa["accepted_sha256"]
...
manifest = {
    ...
    "visual_qa_gate": {
        ...
        "artifact_exists": visual_path.is_file(),
