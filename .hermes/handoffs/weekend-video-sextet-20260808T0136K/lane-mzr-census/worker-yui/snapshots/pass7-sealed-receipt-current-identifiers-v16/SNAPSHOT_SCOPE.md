# Exact review-packet scope — pass-7 v16
...
- Exact v13 external-anchor storyboard contract with unchanged v8 audience/build semantics, complete-audience projection over narration/screen/citations, canonical-hash-pinned neutral questions, content-only proposal receipt with runtime sealed authentication, approved contract, full-inventory manifest validator, visual-v9-authenticating preparers, numeric-audit contract, deterministic mutation suite, and v16 local-check receipt.
...
- Narration-manifest preparation rejects an absent or hash-mismatched accepted visual; the paper-naive packet title is derived from current storyboard version.
...
- Current worker identifiers consistently name storyboard v13, packet v16, and visual v9; operative timing guidance uses the three-second ceiling. Stored proposal content and 32-case mutation receipts are exact-checkable in sealed replay without self-referential manifest claims.
