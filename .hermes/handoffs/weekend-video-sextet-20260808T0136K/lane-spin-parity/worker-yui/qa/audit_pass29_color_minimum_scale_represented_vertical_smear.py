#!/usr/bin/env python3
"""Quantify color/monochrome -> 360p -> represented-pixel vertical width-3 smear interaction."""
...
OUT = ROOT / "qa/pass29_color_minimum_scale_represented_vertical_smear_quantitative_audit.json"
WIDTH = 3
...
VARIANTS = [
    "color_then_360p_then_represented_vertical_smear_w03",
    "grayscale_bt709_then_360p_then_represented_vertical_smear_w03",
    "protanopia_machado100_then_360p_then_represented_vertical_smear_w03",
    "deuteranopia_machado100_then_360p_then_represented_vertical_smear_w03",
    "tritanopia_machado100_then_360p_then_represented_vertical_smear_w03",
]
...
def main() -> None:
    ...
    human_review = {
        "candidate": {"result_hierarchy_primary": True, "structural_held_gate_scenes": "0/16_ALL_FIVE_VARIANTS", "fine_support_softens_first": ["horizontal glyph strokes", "horizontal separators", "fine axes and grid rules", "error-bar caps", "units", "legends", "caveats", "citations", "provenance", "small qualifiers"], "clipping_overlap_or_meaning_changing_ambiguity": False, "transform_repairs_or_authorizes_candidate": False},
    ...
    audit = {
        ...
        "deepening_pass": 29,
        "transform": "native color/monochrome -> Pillow LANCZOS 640x360 -> represented-pixel centered vertical width-3 box smear",
