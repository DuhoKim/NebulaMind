#!/usr/bin/env python3
"""Build method proofs for color/monochrome -> 360p -> represented-pixel horizontal width-3 smear."""
...
OUT = ROOT / "qa/pass28_v8_color_minimum_scale_represented_smear"
...
def main() -> None:
    ...
    receipt = {
        "audit": "method_proofs_native_monochrome_and_color_vision_then_minimum_scale_then_represented_pixel_horizontal_smear",
        "deepening_pass": 28,
