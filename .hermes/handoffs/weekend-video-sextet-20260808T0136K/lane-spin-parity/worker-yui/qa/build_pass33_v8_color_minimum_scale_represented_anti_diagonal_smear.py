#!/usr/bin/env python3
"""Build method proofs for color/monochrome -> 360p -> represented-pixel centered anti-diagonal width-3 smear."""
...
OUT = ROOT / "qa/pass33_v8_color_minimum_scale_represented_anti_diagonal_smear"
...
def main() -> None:
    ...
    receipt = {
        "audit": "method_proofs_native_monochrome_and_color_vision_then_minimum_scale_then_represented_pixel_main_diagonal_smear",
        "deepening_pass": 33,
