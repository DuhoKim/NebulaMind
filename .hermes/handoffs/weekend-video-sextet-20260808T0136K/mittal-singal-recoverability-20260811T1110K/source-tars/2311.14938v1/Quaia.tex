...
\label{sec:results}
    ...
    \subsubsection{Low galactic masks: $|b| < 10^\circ$, $20^\circ$, $30^\circ$}
        ...
        The model with the second-highest Bayes factor in Table~\ref{tab:data-qlow-c30-p2p} -- the kinematic dipole $M_6$ -- yields a relative Bayes factor of $\ln B_{25} = 3.4$.
...
\section{Discussion \& Conclusions}\label{sec:discussion}
    ...
    \subsection{Impact of priors on results}
        ...
        With more restrictive priors, we find that out conclusions do not change; that is, our findings are not strongly sensitive to the choice of prior.
