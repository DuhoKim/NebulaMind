# DECISION MEMO (Revision 5) — the frozen gate is preserved intact, and the investigator declines to proceed

Hwao, Revision 5, 2026-08-21. **DRAFT. Not effective. It requires a gate AND Duho's signature,
and it has neither — the decline described here is NOT in force.** Revisions 1-4 retained
byte-for-byte as `..._REV1..REV4_SUPERSEDED.md`.
...
- **2026-08-20 23:12**, seq 20 — *"The first 3 real values: zero point 27, zero point 20, and minus
  ...
  the authorization.
- **2026-08-20 23:13 and 23:24**, seq 21 **and seq 22** — the sign statement, republished. The archive pages carry copies too, but they concatenate many
  readings, so a match inside one is **not attributable to a particular report** and is not
  counted as a separate disclosure.
