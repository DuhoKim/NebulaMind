...
The document and script matched the dispatched SHA-256 values at opening, immediately before execution, and immediately before this report was first written. `/bin/zsh -f _evidence_20260822/verify.sh` self-reported the pinned script digest, enumerated 28 claim invocations, produced 28 PASS and 0 FAIL, and exited 0. The v8 duplication/parser-prose defect is closed, P4 now implements the narrowly disclosed exact source-substring count, and the v7-gate concurrent edit recorded by v8 does not enter either pinned v9 artifact or any pinned v9 claim input.

A final post-write custody check then found both named target paths changed concurrently: the document became `9f9ae01885f383c414999e19bedd8d9d0351f7a0609a267bad9bffe8a4f3d937` at 16:36:37 KST and the script became `6509bb14fee659adcbcd3c3571de84dd898f5b289e6318227be0a72237b47d7e` at 16:36:15 KST. Only hashes, sizes, and mtimes of those replacement bytes were inspected; their content was not opened and does not affect this exact-dispatch verdict. All target line references and content findings below bind only the dispatched `c6138ba1...` / `5ccf5eef...` bytes.
...
- `c6138ba1acedf2123270d1f4ef5e073df1e7e2e70f5768ccc2484e26abd52503`  `CHI_CUSTODY_20260822.md` — reviewed dispatch bytes; exact match at opening, execution, and pre-report; live path later drifted to `9f9ae018...`.
- `5ccf5eef957bc19f052c75ffa0d039d0c47542b4d408f0b106885ae1052ab5ea`  `_evidence_20260822/verify.sh` — reviewed dispatch bytes; exact match at opening, execution, and pre-report; live path later drifted to `6509bb14...`.
...
### 0. BLOCKING — both named target paths mutated after the report was first written

The final live-path digests no longer equal either user-pinned dispatch digest. Replacement content was deliberately not opened and is outside this exact-pin review. This is a path-custody failure separate from the pinned-byte content refutations below.
...
```text
c6138ba1acedf2123270d1f4ef5e073df1e7e2e70f5768ccc2484e26abd52503  CHI_CUSTODY_20260822.md (reviewed dispatch bytes; live path later drifted)
5ccf5eef957bc19f052c75ffa0d039d0c47542b4d408f0b106885ae1052ab5ea  _evidence_20260822/verify.sh (reviewed dispatch bytes; live path later drifted)
9f9ae01885f383c414999e19bedd8d9d0351f7a0609a267bad9bffe8a4f3d937  CHI_CUSTODY_20260822.md (replacement hash-only; content not opened)
6509bb14fee659adcbcd3c3571de84dd898f5b289e6318227be0a72237b47d7e  _evidence_20260822/verify.sh (replacement hash-only; content not opened)
...
- The named v8 report changed concurrently during this pass; both observed digests are recorded. Both named v9 target paths also changed only after this report was first written; replacement content was not opened.
