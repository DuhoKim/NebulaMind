#!/bin/zsh
# Executable custody claims, v6. THE PRINTED COMMAND IS THE EXECUTED COMMAND:
# claim() takes one string, eval-runs exactly it, and prints exactly it. Fifteen gate
...
claim P3 "python3 -c \"
t=open('$R/archive.html',encoding='utf-8',errors='replace').read()
i=t.index('<li data-src=\\\"20260820T231235-hwao-report.mp3\\\"')
entry=t[i:t.index('</li>',i)]
print(entry.count('0.834336, 0.384410, and -0.640352'))\"" 1
claim P4 "python3 -c \"
t=open('$R/archive.html',encoding='utf-8',errors='replace').read()
i=t.index('<li data-src=\\\"20260820T231235-hwao-report.mp3\\\"')
entry=t[i:t.index('</li>',i)]
print(entry.count('report-20260820T231235-hwao-report'))\"" 1

echo "\n== superseded forms retained on disk (the drafting history, countable) =="
claim L1 "ls $P/CHI_CUSTODY_RECEIPT_20260821*.md $P/CHI_CUSTODY_20260822_V*_SUPERSEDED.md | wc -l | tr -d ' '" 13
