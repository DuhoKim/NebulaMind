#!/bin/zsh
# Executable custody claims, v9. THE PRINTED COMMAND IS THE EXECUTED COMMAND:
# claim() takes one string, eval-runs exactly it, and prints exactly it. Eighteen gate
...
claim P3 "grep -cF '0.834336, 0.384410, and -0.640352' $R/report-20260820T231235-hwao-report.html" 1
...
claim L1 "ls $P/CHI_CUSTODY_RECEIPT_20260821*.md $P/CHI_CUSTODY_20260822_V*_SUPERSEDED.md | wc -l | tr -d ' '" 16
