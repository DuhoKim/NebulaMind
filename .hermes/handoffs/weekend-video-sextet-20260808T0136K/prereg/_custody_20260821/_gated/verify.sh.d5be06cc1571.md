#!/bin/zsh
# Executable custody claims, v8. THE PRINTED COMMAND IS THE EXECUTED COMMAND:
# claim() takes one string, eval-runs exactly it, and prints exactly it. Seventeen gate
...
claim P4 "grep -cF 'report-20260820T231235-hwao-report' $R/archive.html" 1

echo "\n== superseded forms retained on disk (the drafting history, countable) =="
claim L1 "ls $P/CHI_CUSTODY_RECEIPT_20260821*.md $P/CHI_CUSTODY_20260822_V*_SUPERSEDED.md | wc -l | tr -d ' '" 15
