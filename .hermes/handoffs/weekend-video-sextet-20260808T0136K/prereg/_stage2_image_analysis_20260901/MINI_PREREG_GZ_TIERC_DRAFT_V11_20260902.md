...
| V11 | coverage plane inverse-variance → exposure count by Duho's ruling 'b' (Blanc relay 2026-09-03 15:20 KST); ruling 'a' (validation only) and every other clause unchanged. |
