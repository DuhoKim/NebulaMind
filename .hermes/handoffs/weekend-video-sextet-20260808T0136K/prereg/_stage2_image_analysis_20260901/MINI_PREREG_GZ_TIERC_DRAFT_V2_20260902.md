...
Draft V2 for principal signature, 2026-09-02.
...
2.10 The verdict program is `miniprereg_pins/concordance_verdict.py`, SHA-256 `1f16d2c33c2b0725241b4013bfced45cb822c0d7b111aec70eac235e63b6284d`. Its fixture test is `miniprereg_pins/test_concordance_verdict.py`, SHA-256 `b602a39dd09f09c035c19394589e7f739d098994fa477a477197f37baf9a03e5`.
...
10.1a The parent preregistration, `../_successor_build_20260824/PREREG_SUCCESSOR_DRAFT_V113_20260830.md`, lines 124--129, is imported verbatim:
...
| Finding | Disposition |
|---|---|
| F1 FATAL | BUILT AND PINNED in §2: verdict program and test, BS-4 fixture specification, rendering configuration, environment-record schema, and published-checksum reference implementation/convention; §16 carries the passing fixture receipt. |
| F2 FATAL | Parent lines 124--129 are quoted and cited verbatim in §10, with East-of-North, both signed `0.0408` constants, BATTERY-SIGN refusal, and this study's pre-GZ rendering+instrument-chain meaning made explicit; the pinned BS-4 specification carries the same constants. |
| F3 MINOR | §6.2 now uses agy's exact required GZ1_OBJID formatting wording. |

## 19. Frozen rule register

The following V1 register of 96 load-bearing constants or rules is preserved verbatim. For V2, the `COUNT` trailer instead counts the 11 distinct SHA-256-pinned file identities present in this document, as required by the V2 repair instruction:
