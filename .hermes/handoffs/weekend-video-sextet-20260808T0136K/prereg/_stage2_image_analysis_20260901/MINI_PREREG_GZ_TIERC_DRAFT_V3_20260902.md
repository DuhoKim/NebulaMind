...
**V3 CANONICAL, V2 and V1 SUPERSEDED.**

Draft V3 for principal signature, 2026-09-02.
...
The same V3 pin audit independently re-hashed every unchanged pinned identity and confirmed the §2.1, §2.2, §2.5, §2.6, §2.11, §2.12, §2.13, and §9.1 digests exactly as printed. It also re-hashed the unchanged live acquisition source for the §2.14 byte-identity check. The changed §2.10 files and new §2.14 static copy were independently hashed before their real digests were inserted; no placeholder is present.
