...
## CORRECTION (2026-09-07 06:22 KST) — this file is a RECONSTRUCTION from a captured tail, not the original bytes; the coordinating Codex recovered the ORIGINAL exactly
`CODEX_TRACK12_RUN1_ORIGINAL_RECOVERED_20260907.md` (sha256 5577657864d57b0b9a6440b49cee5526c6de3f3dafee102855efb3765b03b374) reproduces the overwritten receipt's exact pre-overwrite digest, recorded by the coordinating Codex before the overwrite (`.hermes/CODEX_TRACK12_RUN1_RECOVERY_20260907.md`). It holds all nine method lines and the assertion details. Two statements above are WRONG and stand corrected by it: the copies were NOT byte-identical to v11/v15 — they carried renamed import lines — and their digests at run time were 4d4a2a439765d394 (provenance copy) and 02c2826bef17e0ef (driver copy), not the v11/v15 digests I quoted; and the first four method lines that "scrolled above the capture" are present in the recovered original. The recovered file is the authority for the original run; this file remains as the record of the reconstruction and of what that run reached per subcase. No execution credit is added to unreached subcases (codex, Blanc 05:09).
