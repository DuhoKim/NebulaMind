# V28 CANDIDATE — COHERENT-ATTACK INSPECTION (staged, UNADOPTED) — 2026-09-07 02:21 KST

Executed: `_optionA_dev/track1/coherent_attacks_v28.py` (SHA-256 7823d819d21d49f2016ff8a49d7fa32f3ce3a0c7fbf9d15b6e604f2c82ff0f1e) — driver v12, verdict v28, provenance_designs_v8; the modules named in the header are the modules imported and executed (codex V27-3). Warning-strict (`-W error::ResourceWarning`); the one inherited RuntimeWarning at fourier_chirality.py:87 is the known, disclosed one. Every row carries the SAME verdict as the V27 inspection; only the refusal wording of rows 10b/10c changed (v8's precedence-aware messages; a fresh fixture commit hash).

TWO CATEGORIES, KEPT APART (Blanc 02:06): rows 1, 2, 6 and 10b–10d show the offline candidate LOADING counter-cases 1, 2, A and the inherited list trust — DISCLOSED LIMITS (column one of §3c; `LIMITS_VS_CONTRADICTIONS_20260907.md`). No row in this table is an unrepaired contradiction; V27-1/V27-2 are repaired in the executed modules (`TRACK8_FAIL_FIRST_RECEIPT_20260907.md`).

| attack | staged V28 candidate (driver v12 / verdict v28 / provenance v8) | note |
|---|---|---|
...
| 10c attack 2 again: history rebuilt after honest publication, coherently sealed and pushed fast-forward | offline: ACCEPTED / composed: REFUSED HISTORY-CONTINUATION (HISTORY-NOT-AN-EXTENSION at 29a882a1aa7c) | same identity, same load_identity call; composed = UNADOPTED |
