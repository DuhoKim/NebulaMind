# V30 CANDIDATE — COHERENT-ATTACK INSPECTION (staged, UNADOPTED) — 2026-09-07 03:36 KST

Executed: `_optionA_dev/track1/coherent_attacks_v30.py` (SHA-256 3deb4802d3dd89c9ec121789df9d1aced80d17b950f3e8a06274836ba5dbf896) — driver v14 (ONE resolver), verdict v30, provenance_designs_v10; the modules named in the header are the modules imported and executed. Warning-strict; the one inherited RuntimeWarning at fourier_chirality.py:87 is the known one. Every row carries the SAME verdict as the V29 inspection (35 rows; fixture commit hashes differ per run).

TWO CATEGORIES, KEPT APART (Blanc 02:06): rows 1, 2, 6 and 10b–10d show the offline candidate LOADING counter-cases 1, 2, A and the inherited list trust — DISCLOSED LIMITS (column one of §3c). The precedence pairs are exhibited separately (`V30_PRECEDENCE_EXHIBIT_20260907.md`) and executed on the complete path by tracks 8–10. No row here is an unrepaired contradiction.

| attack | staged V30 candidate (driver v14 / verdict v30 / provenance v10) | note |
|---|---|---|
...
| 10c attack 2 again: history rebuilt after honest publication, coherently sealed and pushed fast-forward | offline: ACCEPTED / composed: REFUSED HISTORY-CONTINUATION (HISTORY-NOT-AN-EXTENSION at 95c8fecafed5) | same identity, same load_identity call; composed = UNADOPTED |
