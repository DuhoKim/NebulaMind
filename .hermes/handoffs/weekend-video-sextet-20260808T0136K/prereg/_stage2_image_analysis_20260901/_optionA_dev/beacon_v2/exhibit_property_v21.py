#!/usr/bin/env python3
"""EXHIBIT (option A V21, drand-only): the SEED is a function of (round, pinned public key) — INCLUDING the first-collection case that refuted V19 — and
...
import beacon_record_drand_v21 as BD, verify_drand_v2 as vd
