...
import beacon_record_drand_v26 as BD, verify_drand_v2 as vd
...
class T(unittest.TestCase):
    ...
    def test_zzz_every_token_exercised(self):
        src = (HERE / "beacon_record_drand_v26.py").read_text(); toks = {"REFUSE-" + t for t in re.findall(r'refuse\("([A-Z0-9-]+)"', src)} | {"ACCEPT-DRAND", "RETRY"}
