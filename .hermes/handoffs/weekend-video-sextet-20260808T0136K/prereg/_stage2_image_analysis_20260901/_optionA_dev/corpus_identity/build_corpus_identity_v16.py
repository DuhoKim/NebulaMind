#!/usr/bin/env python3
"""Build the ordered, catalogue-only corpus identity and CSV templates. V16 VARIANT: identical to build_corpus_identity.py except the beacon import (see line 11)."""
...
import beacon_record_expedited as beacon_record, nist_pulse   # option A V16 draft: the EXPEDITED verdict (FALLBACK_AFTER_H = 0; old T_sign and the public 00:15Z pulse refused by name); otherwise byte-identical to build_corpus_identity.py
