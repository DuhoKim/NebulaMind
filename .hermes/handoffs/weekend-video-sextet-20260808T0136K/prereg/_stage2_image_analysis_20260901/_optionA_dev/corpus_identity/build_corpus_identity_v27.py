...
import beacon_record_drand_v27 as beacon_record, verify_drand_v2 as verify_drand, history_v2 as H   # option A V21: drand-only verdict (BLS verified under the pinned key) + the APPROVAL WITNESS below
...
def _reconcile():
    ...
    sys.path.insert(0, str(HERE.parent/'track2')); import provenance_designs_v7 as P
