...
HERE = Path(__file__).resolve().parent; sys.path.insert(0, str(HERE)); import history_v2 as H
class T(unittest.TestCase):
    ...
    def test_reset_and_reorder_and_unknown_refused(self):
        ...
        with self.assertRaises(SystemExit): H.genesis(self.p, "a" * 64, "t", "b" * 64, 1)                # v2: even an empty existing file refuses (exclusive creation)
