"""Fixture for the STAGED driver v13 (V29 candidate; NOT GATED, NOT ADOPTED): composed mode on provenance_designs_v9 — the fixture text below is inherited unchanged from the v8 fixture (V24) onward; only the import lines changed at each successor (codex V28-3: the header had kept calling itself the v8/V24 fixture). It was — Fixture for the STAGED driver v8 (V24 candidate; NOT GATED, NOT ADOPTED): composed mode on provenance_designs_v4 — one fixture PushEvent per published history commit (before = parent). Earlier fixture text follows.
...
import run_configurations_v13 as rc, fourier_chirality as fc
...
import beacon_record_drand_v29 as BD, verify_drand_v2 as vd, history_v2 as H
...
class T(unittest.TestCase):
    ...
    def test_real_builder_output_loads_through_load_identity(self):        # END-TO-END (V21): real public round (BLS-verified) -> collector CLI (genesis) -> V21 builder -> driver v5 with PRODUCTION's re-deriver
        ...
        import build_corpus_identity_v29 as B20
