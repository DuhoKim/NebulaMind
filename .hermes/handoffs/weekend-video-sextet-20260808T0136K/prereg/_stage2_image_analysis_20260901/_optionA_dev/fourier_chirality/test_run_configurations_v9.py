"""Fixture for the STAGED driver v8 (V24 candidate; NOT GATED, NOT ADOPTED): composed mode on provenance_designs_v4 — one fixture PushEvent per published history commit (before = parent). Earlier fixture text follows.
...
import run_configurations_v9 as rc, fourier_chirality as fc
...
import beacon_record_drand_v25 as BD, verify_drand_v2 as vd, history_v2 as H
...
class T(unittest.TestCase):
    ...
    def test_real_builder_output_loads_through_load_identity(self):        # END-TO-END (V21): real public round (BLS-verified) -> collector CLI (genesis) -> V21 builder -> driver v5 with PRODUCTION's re-deriver
        ...
        import build_corpus_identity_v25 as B20
