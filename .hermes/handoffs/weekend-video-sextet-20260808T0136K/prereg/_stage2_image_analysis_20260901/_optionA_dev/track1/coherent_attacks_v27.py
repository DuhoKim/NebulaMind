#!/usr/bin/env python3
"""COHERENT-ATTACK INSPECTION of the STAGED V27 candidate (driver v11, verdict v27, provenance_designs_v7; supersedes the V26 inspection; earlier scripts retained
...
standalone v6 helpers. Prints one row per case. Deterministic; the output is filed as V27_CANDIDATE_ATTACK_INSPECTION_20260907.md."""
...
import run_configurations_v11 as rc, test_run_configurations_v11 as TF, history_v2 as H, provenance_designs_v7 as P, verify_drand_v2 as vd
...
import beacon_record_drand_v27 as BD
...
print("| attack | staged V27 candidate (driver v11 / verdict v27 / provenance v7) | note |"); print("|---|---|---|")
