#!/usr/bin/env python3
"""COHERENT-ATTACK INSPECTION of the STAGED V28 candidate (driver v12, verdict v28, provenance_designs_v8; supersedes the V27 inspection; earlier scripts retained
as pinned). Re-runs every reviewer counter-case with adjacent digests, counts and locks kept COHERENT, against DRIVER v12 with PRODUCTION's own re-deriver, and the
standalone v8 helpers — the modules this script imports are the ones it executes (codex V27-3: the V27 header named v10/v6 while executing v11/v7). Prints one row per case.
Deterministic; the output is filed as V28_CANDIDATE_ATTACK_INSPECTION_20260907.md."""
...
import run_configurations_v12 as rc, test_run_configurations_v12 as TF, history_v2 as H, provenance_designs_v8 as P, verify_drand_v2 as vd
...
import beacon_record_drand_v28 as BD
...
print("| attack | staged V28 candidate (driver v12 / verdict v28 / provenance v8) | note |"); print("|---|---|---|")
