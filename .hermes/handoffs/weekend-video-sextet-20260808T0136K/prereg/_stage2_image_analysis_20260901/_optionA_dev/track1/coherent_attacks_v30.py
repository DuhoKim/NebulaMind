#!/usr/bin/env python3
"""COHERENT-ATTACK INSPECTION of the STAGED V30 candidate (driver v14, verdict v30, provenance_designs_v10 — ONE resolver; supersedes the V29 inspection; earlier scripts retained
as pinned). Re-runs every reviewer counter-case with adjacent digests, counts and locks kept COHERENT, against DRIVER v14 with PRODUCTION's own re-deriver, and the
standalone v10 helpers — the modules this script imports are the ones it executes (codex V27-3: the V27 header named v10/v6 while executing v11/v7). Prints one row per case.
Deterministic; the output is filed as V30_CANDIDATE_ATTACK_INSPECTION_20260907.md."""
...
import run_configurations_v14 as rc, test_run_configurations_v14 as TF, history_v2 as H, provenance_designs_v10 as P, verify_drand_v2 as vd
...
import beacon_record_drand_v30 as BD
...
print("| attack | staged V30 candidate (driver v14 / verdict v30 / provenance v10) | note |"); print("|---|---|---|")
