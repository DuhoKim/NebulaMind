#!/usr/bin/env python3
"""COHERENT-ATTACK INSPECTION of the STAGED V31 candidate (driver v15, verdict v31, provenance_designs_v11 — staged finding collector; supersedes the V30 inspection; earlier scripts retained
as pinned). Re-runs every reviewer counter-case with adjacent digests, counts and locks kept COHERENT, against DRIVER v15 with PRODUCTION's own re-deriver, and the
standalone v11 helpers — the modules this script imports are the ones it executes (codex V27-3: the V27 header named v10/v6 while executing v11/v7). Prints one row per case.
Deterministic; the output is filed as V31_CANDIDATE_ATTACK_INSPECTION_20260907.md."""
...
import run_configurations_v15 as rc, test_run_configurations_v15 as TF, history_v2 as H, provenance_designs_v11 as P, verify_drand_v2 as vd
...
import beacon_record_drand_v31 as BD
...
print("| attack | staged V31 candidate (driver v15 / verdict v31 / provenance v11) | note |"); print("|---|---|---|")
