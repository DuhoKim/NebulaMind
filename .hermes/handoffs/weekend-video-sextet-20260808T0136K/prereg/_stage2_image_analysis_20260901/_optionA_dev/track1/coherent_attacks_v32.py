#!/usr/bin/env python3
"""COHERENT-ATTACK INSPECTION of the STAGED V32 candidate (driver v16, verdict v32, provenance_designs_v12 — NSD: independent contributing stages; supersedes the V31 inspection; earlier scripts retained
as pinned). Re-runs every reviewer counter-case with adjacent digests, counts and locks kept COHERENT, against DRIVER v16 with PRODUCTION's own re-deriver, and the
standalone v12 helpers — the modules this script imports are the ones it executes (codex V27-3: the V27 header named v10/v6 while executing v11/v7). Prints one row per case.
Deterministic; the output is filed as V32_CANDIDATE_ATTACK_INSPECTION_20260907.md."""
...
import run_configurations_v16 as rc, test_run_configurations_v16 as TF, history_v2 as H, provenance_designs_v12 as P, verify_drand_v2 as vd
...
import beacon_record_drand_v32 as BD
...
print("| attack | staged V32 candidate (driver v16 / verdict v32 / provenance v12) | note |"); print("|---|---|---|")
