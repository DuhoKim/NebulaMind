#!/usr/bin/env python3
"""COHERENT-ATTACK INSPECTION of the STAGED V33 candidate (driver v17, verdict v33, provenance_designs_v13 + precedence_core — NSD at input granularity; supersedes the V32 inspection; earlier scripts retained
as pinned). Re-runs every reviewer counter-case with adjacent digests, counts and locks kept COHERENT, against DRIVER v17 with PRODUCTION's own re-deriver, and the
standalone v13 helpers — the modules this script imports are the ones it executes (codex V27-3: the V27 header named v10/v6 while executing v11/v7). Prints one row per case.
Deterministic; the output is filed as V33_CANDIDATE_ATTACK_INSPECTION_20260907.md."""
...
import run_configurations_v17 as rc, test_run_configurations_v17 as TF, history_v2 as H, provenance_designs_v13 as P, verify_drand_v2 as vd
...
import beacon_record_drand_v33 as BD
...
print("| attack | staged V33 candidate (driver v17 / verdict v33 / provenance v13) | note |"); print("|---|---|---|")
