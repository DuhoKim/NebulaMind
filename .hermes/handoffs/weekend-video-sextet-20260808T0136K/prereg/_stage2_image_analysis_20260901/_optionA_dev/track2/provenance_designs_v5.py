"""TRACK 2 v5 — RECOMMENDED, UNADOPTED designs, repaired after codex's V24 review (N1, N2, N3). THE COVENANT, stated as codex's clause (N1): the validator
...
provenance_designs.py. Wired into the production driver (v9) ONLY behind `Protocol.provenance_mode = 'composed'` (default 'offline'); UNADOPTED.
