...
for m in fourier_chirality/test_run_configurations_v14 fourier_chirality/test_run_configurations corpus_identity/test_history_v2 corpus_identity/test_approval_witness_v4 corpus_identity/test_build_corpus_identity_v30 corpus_identity/test_build_corpus_identity beacon_v2/test_beacon_record_drand_v30 drand_only/test_verify_drand_v2 track2/test_track2_fail_first track2/test_provenance_designs; do
