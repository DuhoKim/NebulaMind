#!/usr/bin/env python3
"""check_pin_consistency_v2 (Tier-C V37 draft): identical to its V35 §2.15 predecessor except that the positive-control pin is study_renderer/renderer_v4.py.
...
BARE_RE = re.compile(r'`([A-Za-z0-9_.-]+\.' + EXT + r')`, SHA-256 `([0-9a-f]{64})`')
HASH = r'`?([0-9a-f]{64})`?'
