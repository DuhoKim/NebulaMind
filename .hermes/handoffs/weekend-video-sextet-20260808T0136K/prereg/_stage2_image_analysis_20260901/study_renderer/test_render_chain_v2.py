"""Integration fixture for render_chain_v2 — the receipts codex's V36 report required: through the ACTUAL renderer, (a) one zero-exposure
...
from study_renderer import render_chain_v2 as rc, renderer_v3 as rv3, pixel_rejection_v2 as prj
