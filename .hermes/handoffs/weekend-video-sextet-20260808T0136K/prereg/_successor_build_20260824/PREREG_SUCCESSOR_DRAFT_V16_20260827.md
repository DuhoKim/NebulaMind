...
> and a fresh text gate, not a receipt insertion**. On today's count: **BS-2a and BS-2k are DESIGN slots.** One of fourteen class-P slots is filled (BS-2m). There are 7 class-E slots. (Lint assertion: the prose count equals the parsed table count and the DESIGN inventory matches the VALUE/DESIGN classification.)
