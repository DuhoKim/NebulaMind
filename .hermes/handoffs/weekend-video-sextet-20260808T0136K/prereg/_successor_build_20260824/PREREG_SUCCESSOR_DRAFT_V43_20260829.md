# PREREGISTRATION DRAFT V43 — LONGO-AMPLITUDE TEST ON A LEVERAGE-CHOSEN FOOTPRINT
...
| V42 → V43 | `6c9cc2fca67d5aff` | (this revision) | §5 (+2/−6), §7.1 (+1/−1), §10 (+1/−0) | no row-count change | PRINCIPAL-20260829-RERUN-OPTION-A (delete the rerun allowance; the halt is terminal), GPT56-V40-5 (calibration/computation overlap) |
