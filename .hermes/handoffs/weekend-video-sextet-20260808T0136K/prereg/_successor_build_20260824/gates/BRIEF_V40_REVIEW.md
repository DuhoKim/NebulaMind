# BRIEF — V40 whole-document referee round

**Subject:** `PREREG_SUCCESSOR_DRAFT_V40_20260829.md`
**sha256 `531d3f40f06130e792ff474e660fde931038e2d7bd8e573612b90c8ec624c1f6`**
...
V37 and V40 apply **principal decisions relayed 2026-08-29 09:20 and 10:15**. They are not my
...
## Since V38 — what V39 and V40 did
...
**V40 implements a principal ruling on CODEX-V38 F2 (option C).** §5's VOID trigger is split by kind:
...
## Attack these specifically — the V40 repair above all
...
- **The citation check in `tools/prereg_lint.py` is QUARANTINED.** Its findings emit as
  ...
  that work is not in this draft. **`prereg_lint.py` therefore exits 1 on V40 with exactly one
...
Write to `gates/V40_WHOLE_REVIEW_<SEAT>.md` where `<SEAT>` is `GPT56` or `CODEX`.
