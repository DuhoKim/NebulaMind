...
RESIDUES = (
    ...
    ("The echo controls' exact contracts (per-echo, no blanket demotion)",
     ...
     "mention + EVERY backticked `(kind,`-opening candidate whose opening lies in the "
     "900-byte adjacency, READ WHOLE wherever it closes (GPT56-V121A F1: a window "
     "slice truncated long candidates) — any length, any internal whitespace (GPT56/CODEX-V120A F2: the first grammar demanded "
