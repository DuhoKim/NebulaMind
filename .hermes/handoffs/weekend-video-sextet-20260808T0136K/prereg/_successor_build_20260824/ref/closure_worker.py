...
Usage: echo '{"manifest": ["0001m250", ...]}' | python3 -I closure_worker.py [--work-dir DIR]
"""
...
SUBJECT = HERE / "successor_ref_v6.py"
...
def main() -> int:
    ...
    if args.self_check:
        json.dump({"outcome": "SELF-CHECK", "worker": str(SUBJECT.parent / "closure_worker.py"),
