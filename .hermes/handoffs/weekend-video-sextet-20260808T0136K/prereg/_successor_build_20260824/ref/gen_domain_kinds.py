...
DECLARED = {
    ...
    "successor-export-prelock": "successor-export-prelock",
    "terminal-enumeration-set": "terminal_enumeration_digest",
...
PREIMAGE_OF = [
    ...
    (r"^revrec\.evidence_ref$", ("RAW",
     "evidence artifact whose canonical body begins with the adjudicated "
