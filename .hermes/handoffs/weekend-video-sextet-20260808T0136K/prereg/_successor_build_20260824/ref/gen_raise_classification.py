...
INTEG = {64,856,858,860,862,864,867,872,876,885,887,889,891,1601,1605,1687}
# 1641/1643 moved INTEGRITY -> CALLER at V100 (CODEX-V99 F5): require_authorization tests
# the CALLER-SUPPLIED (authorization_path, authorization_sha256) pair's coherence - an
# unreadable path or a digest mismatch of supplied inputs is argument admissibility, not
# state corruption; the as-supplied boundary as written.
...
CALLER = CALLER | {1649} | RESOLVED | {1677, 1681} | {1641, 1643}
...
ANNOT = {
    ...
    1641: " (tests the supplied authorization pair; unreadable path = argument admissibility "
          "— moved CALLER, CODEX-V99 F5)",
    1643: " (tests the supplied authorization pair; digest mismatch of supplied inputs — "
          "moved CALLER, CODEX-V99 F5)",
