SOURCE URL: https://www.legacysurvey.org/acknowledgment/
TITLE: Acknowledgments for all Data from the Legacy Surveys | Legacy Survey
ACCESSED: 2026-08-12 KST

[Skip to main content](https://www.legacysurvey.org/acknowledgment/#content)

## [Usage of images from the Sky Viewer](https://www.legacysurvey.org/acknowledgment/\#toc-entry-1)

The Legacy Surveys Sky Viewer web sites [viewer.legacysurvey.org](http://viewer.legacysurvey.org/) and
[legacysurvey.org/viewer](https://www.legacysurvey.org/viewer) provide images from a number of surveys
...
- SDSS - [https://www.sdss.org](https://www.sdss.org/) \- [https://www.sdss.org/collaboration/#image-use](https://www.sdss.org/collaboration/#image-use)

- DES DR1 - [https://www.darkenergysurvey.org/](https://www.darkenergysurvey.org/) \- [https://des.ncsa.illinois.edu/terms](https://des.ncsa.illinois.edu/terms)

- HSC DR2 - [https://hsc-release.mtk.nao.ac.jp/doc/index.php/tools-2/](https://hsc-release.mtk.nao.ac.jp/doc/index.php/tools-2/) \- [https://www.nao.ac.jp/en/policy-guide.html](https://www.nao.ac.jp/en/policy-guide.html)

- VLASS 1.2 - [https://public.nrao.edu/vlass/](https://public.nrao.edu/vlass/) \- [https://public.nrao.edu/media-use/](https://public.nrao.edu/media-use/)

- GALEX - [http://www.galex.caltech.edu/](http://www.galex.caltech.edu/) \- [https://www.jpl.nasa.gov/imagepolicy/](https://www.jpl.nasa.gov/imagepolicy/)

- Halpha - [https://faun.rc.fas.harvard.edu/dfink/skymaps/halpha/](https://faun.rc.fas.harvard.edu/dfink/skymaps/halpha/)

- SFD - [https://dustmaps.readthedocs.io/en/latest/maps.html#sfd](https://dustmaps.readthedocs.io/en/latest/maps.html#sfd)

- WISE 12 um dust map - [http://wise.skymaps.info/](http://wise.skymaps.info/)
...
Images are licensed under a [Creative Commons Attribution 4.0 International License](https://creativecommons.org/licenses/by/4.0/),
...
## [Scientific Publication Acknowledgment](https://www.legacysurvey.org/acknowledgment/\#toc-entry-2)
...
## [Short Acknowledgment for DESI Collaborators](https://www.legacysurvey.org/acknowledgment/\#toc-entry-3)

If you are _already_ using the [standard DESI Acknowledgments](https://desi.lbl.gov/trac/wiki/GuidetoPub/DESIAcknowledgements#StandardAcknowledgements) in your paper,
you can _replace_ the full Acknowledgment above with this shorter Acknowledgment:
...
LBNL is managed by the Regents of the University of California under contract to the U.S. Department of Energy.
The complete acknowledgments can be found at [https://www.legacysurvey.org/acknowledgment/](https://www.legacysurvey.org/acknowledgment/).

## [Additional Acknowledgments](https://www.legacysurvey.org/acknowledgment/\#toc-entry-4)

### [Photometric Redshifts](https://www.legacysurvey.org/acknowledgment/\#toc-entry-5)

When using data from the [Photometric Redshifts for the Legacy Surveys (PRLS)](https://www.legacysurvey.org/dr8/files#photometric-redshifts) catalog,
please include the following _additional_ acknowledgment:
...
### [Siena Galaxy Atlas](https://www.legacysurvey.org/acknowledgment/\#toc-entry-6)

When using data from the [Siena Galaxy Atlas](https://www.legacysurvey.org/sga/sga2020) please include the following
_additional_ acknowledgment:
