SOURCE URL: https://www.legacysurvey.org/dr10/files/
TITLE: Legacy Survey Files | Legacy Survey
...
| `PRIORITY_INIT` | int64 | See the [DESI data model](https://desidatamodel.readthedocs.io/en/latest/DESI_SURVEYOPS/mtl/main/dark/mtl-dark-hp-HPX.html); set to 3400, appropriate to a QSO, the highest-priority DESI dark-time target (added to facilitate running randoms through the [DESI fiberassign code](https://github.com/desihub/fiberassign)) |\
| `NUMOBS_INIT` | int64 | See the [DESI data model](https://desidatamodel.readthedocs.io/en/latest/DESI_SURVEYOPS/mtl/main/dark/mtl-dark-hp-HPX.html); set to 4, appropriate to a QSO, the highest-priority DESI dark-time target (added to facilitate running randoms through the [DESI fiberassign code](https://github.com/desihub/fiberassign)) |\
| `SCND_TARGET` | int64 | See the [DESI data model](https://desidatamodel.readthedocs.io/en/latest/DESI_SURVEYOPS/mtl/main/dark/mtl-dark-hp-HPX.html); set to 0 (added to facilitate running randoms through the [DESI fiberassign code](https://github.com/desihub/fiberassign)) |\
| `NUMOBS_MORE` | int64 | See the [DESI data model](https://desidatamodel.readthedocs.io/en/latest/DESI_SURVEYOPS/mtl/main/dark/mtl-dark-hp-HPX.html); set to 4, appropriate to a QSO, the highest-priority DESI dark-time target (added to facilitate running randoms through the [DESI fiberassign code](https://github.com/desihub/fiberassign)) |\
| `NUMOBS` | int64 | See the [DESI data model](https://desidatamodel.readthedocs.io/en/latest/DESI_SURVEYOPS/mtl/main/dark/mtl-dark-hp-HPX.html); set to 0 (added to facilitate running randoms through the [DESI fiberassign code](https://github.com/desihub/fiberassign)) |\
| `Z` | float64 | See the [DESI data model](https://desidatamodel.readthedocs.io/en/latest/DESI_SURVEYOPS/mtl/main/dark/mtl-dark-hp-HPX.html); set to -1.0 (added to facilitate running randoms through the [DESI fiberassign code](https://github.com/desihub/fiberassign)) |\
| `ZWARN` | int64 | See the [DESI data model](https://desidatamodel.readthedocs.io/en/latest/DESI_SURVEYOPS/mtl/main/dark/mtl-dark-hp-HPX.html); set to -1 (added to facilitate running randoms through the [DESI fiberassign code](https://github.com/desihub/fiberassign)) |\
| `ZTILEID` | int32 | See the [DESI data model](https://desidatamodel.readthedocs.io/en/latest/DESI_SURVEYOPS/mtl/main/dark/mtl-dark-hp-HPX.html); set to -1 (added to facilitate running randoms through the [DESI fiberassign code](https://github.com/desihub/fiberassign)) |\
| `Z_QN` | float64 | See the [DESI data model](https://desidatamodel.readthedocs.io/en/latest/DESI_SURVEYOPS/mtl/main/dark/mtl-dark-hp-HPX.html); set to -1 (added to facilitate running randoms through the [DESI fiberassign code](https://github.com/desihub/fiberassign)) |\
| `IS_QSO_QN` | int16 | See the [DESI data model](https://desidatamodel.readthedocs.io/en/latest/DESI_SURVEYOPS/mtl/main/dark/mtl-dark-hp-HPX.html); set to -1 (added to facilitate running randoms through the [DESI fiberassign code](https://github.com/desihub/fiberassign)) |\
| `DELTACHI2` | float64 | See the [DESI data model](https://desidatamodel.readthedocs.io/en/latest/DESI_SURVEYOPS/mtl/main/dark/mtl-dark-hp-HPX.html); set to -1 (added to facilitate running randoms through the [DESI fiberassign code](https://github.com/desihub/fiberassign)) |\
| `TARGET_STATE` | char\[30\] | See the [DESI data model](https://desidatamodel.readthedocs.io/en/latest/DESI_SURVEYOPS/mtl/main/dark/mtl-dark-hp-HPX.html); set to "QSO\|UNOBS", denoting an unobserved QSO (added to facilitate running randoms through the [DESI fiberassign code](https://github.com/desihub/fiberassign)) |\
| `TIMESTAMP` | char\[25\] | See the [DESI data model](https://desidatamodel.readthedocs.io/en/latest/DESI_SURVEYOPS/mtl/main/dark/mtl-dark-hp-HPX.html); time at which this random was processed (added to facilitate running randoms through the [DESI fiberassign code](https://github.com/desihub/fiberassign)) |\
| `VERSION` | char\[14\] | See the [DESI data model](https://desidatamodel.readthedocs.io/en/latest/DESI_SURVEYOPS/mtl/main/dark/mtl-dark-hp-HPX.html); version of the `desitarget` code used to process this random (added to facilitate running randoms through the [DESI fiberassign code](https://github.com/desihub/fiberassign)) |\
| `PRIORITY` | int64 | See the [DESI data model](https://desidatamodel.readthedocs.io/en/latest/DESI_SURVEYOPS/mtl/main/dark/mtl-dark-hp-HPX.html); set to 3400, appropriate to a QSO, the highest-priority DESI dark-time target (added to facilitate running randoms through the [DESI fiberassign code](https://github.com/desihub/fiberassign)) |\
\
The version of the [desitarget](https://github.com/desihub/desitarget/) code used to generate the random catalogs (`2.6.0`) can be extracted from the `VERSION` column. The [code is available on GitHub](https://github.com/desihub/desitarget/blob/2.6.0/bin/select_randoms) (see also [here](https://github.com/desihub/desitarget/blob/2.6.0/py/desitarget/randoms.py)). The\
northern and southern imaging footprints overlap, so, randoms are resolved by [the desitarget code](https://github.com/desihub/desitarget/blob/2.6.0/py/desitarget/targets.py#L1048) at [a particular declination](https://github.com/desihub/desitarget/blob/2.6.0/py/desitarget/io.py#L105) and by the Galactic plane. The result is that\
randoms with locations at Dec ≥≥ 32.375° and that are north of the Galactic Plane are only included in this file if they have pixels in [BASS](https://www.legacysurvey.org/bass)/ [MzLS](https://www.legacysurvey.org/mzls) (`PHOTSYS` set to "N"), and\
randoms with locations at Dec < 32.375° or that are south of the Galactic Plane are only included in this file if they have pixels observed with DECam (`PHOTSYS` set to "S").\
\
Work which uses any of the random catalogs should cite [Myers et al. (2023)](https://ui.adsabs.harvard.edu/abs/2023AJ....165...50M/abstract).\
\
### [randoms-outside-1-\*.fits](https://www.legacysurvey.org/dr10/files/\#toc-entry-14)\
\
...
| `EBV` | float32 | Galactic extinction E(B-V) reddening from [SFD98](https://ui.adsabs.harvard.edu/abs/1998ApJ...500..525S/abstract) |\
\
### [randoms-allsky-1-\*.fits](https://www.legacysurvey.org/dr10/files/\#toc-entry-15)\
\
...
\
### [survey-bricks-dr10-randoms-2.6.0.fits](https://www.legacysurvey.org/dr10/files/\#toc-entry-16)\
\
A similar file to the [survey-bricks.fits.gz](https://www.legacysurvey.org/dr10/files/#survey-bricks-fits-gz) file, but with extra columns to help interpret\

[... middle omitted — see footer ...]

| `decam_mag_i` | float32 | mag | The estimated DECam ii magnitude for [Gaia EDR3](https://gea.esac.esa.int/archive/documentation/GEDR3/Gaia_archive/chap_datamodel/sec_dm_main_tables/ssec_dm_gaia_source.html) stars based on the GG and Bp−RpBp−Rp color |\
| `decam_mag_z` | float32 | mag | The estimated DECam zz magnitude for [Gaia EDR3](https://gea.esac.esa.int/archive/documentation/GEDR3/Gaia_archive/chap_datamodel/sec_dm_main_tables/ssec_dm_gaia_source.html) stars based on the GG and Bp−RpBp−Rp color |\
| `zguess` | float32 | mag | The estimated zz magnitude for [Tycho-2](https://heasarc.gsfc.nasa.gov/W3Browse/all/tycho2.html) stars from matching to [2MASS](https://www.ipac.caltech.edu/project/2mass) and estimating VV to zz transformations based on [APASS](https://www.aavso.org/apass). |\
...
| `gaia_phot_g_mean_mag` | float32 | mag | [Gaia EDR3](https://gea.esac.esa.int/archive/documentation/GEDR3/Gaia_archive/chap_datamodel/sec_dm_main_tables/ssec_dm_gaia_source.html) G band magnitude |\
...
| `gaia_phot_g_n_obs` | int32 |  | [Gaia EDR3](https://gea.esac.esa.int/archive/documentation/GEDR3/Gaia_archive/chap_datamodel/sec_dm_main_tables/ssec_dm_gaia_source.html) G band number of observations |\
| `gaia_phot_bp_mean_mag` | float32 | mag | [Gaia EDR3](https://gea.esac.esa.int/archive/documentation/GEDR3/Gaia_archive/chap_datamodel/sec_dm_main_tables/ssec_dm_gaia_source.html) BP magnitude |\
...
| `gaia_phot_rp_mean_mag` | float32 | mag | [Gaia EDR3](https://gea.esac.esa.int/archive/documentation/GEDR3/Gaia_archive/chap_datamodel/sec_dm_main_tables/ssec_dm_gaia_source.html) RP magnitude |\
...
──────── [TRUNCATED] ────────
Showing 37,481 chars (head) + 12,372 chars (tail) of 92,373 total clean characters.
Full text saved to: /Users/duhokim/.hermes/profiles/tori2/cache/web/www.legacysurvey.org-741e1a8665.md
To read the omitted middle: read_file path="/Users/duhokim/.hermes/profiles/tori2/cache/web/www.legacysurvey.org-741e1a8665.md" offset=410 limit=200  (the file is the complete page; raise/lower offset to page through it).
─────────────────────────────
