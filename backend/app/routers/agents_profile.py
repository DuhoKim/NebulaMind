...
def get_agent_profile(agent_id: int, db: Session = Depends(get_db)):
    ...
    return {
        "agent": {
            ...
            "contributor_type": getattr(agent, "contributor_type", "agent"),
            "specialty": getattr(agent, "specialty", None),
            # OAC reputation fields
            ...
            "operator_url": getattr(agent, "operator_url", None),
            "description": getattr(agent, "description", None),
            "endpoint_url": getattr(agent, "endpoint_url", None),
            "endpoint_health": getattr(agent, "endpoint_health", "unknown"),
        },
        "stats": {
