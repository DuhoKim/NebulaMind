...
## Headline Ratios
- Intros staked: 3/168 (1.8%).
- Base sentence coverage: 2/10 (20.0%).
- Settled share: 142/172 (82.6%).

## Golds
- Stance draft rows: 8 (Papa spot-check required before lock).
- Relevance gold rows: 10; tau_rel=0.55 validate_F1=0.8.
- Tone transfer gate rows: 8 (gate-only; not tuned).
...
- New votes: +3 / -0; seed duplicate stakes skipped 0.
...
- New votes: +0 / -0; seed duplicate stakes skipped 0.
- Would-be trust: consensus (settled share 1.0).
...
- New votes: +0 / -0; seed duplicate stakes skipped 0.
- Would-be trust: consensus (settled share 0.894737).
...
- New votes: +0 / -0; seed duplicate stakes skipped 0.
- Would-be trust: challenged (settled share 0.210526).
...
- New votes: +0 / -0; seed duplicate stakes skipped 0.
- Would-be trust: debated (settled share 0.777778).
...
- New votes: +0 / -0; seed duplicate stakes skipped 0.
- Would-be trust: consensus (settled share 0.944444).
...
- New votes: +0 / -0; seed duplicate stakes skipped 0.
- Would-be trust: debated (settled share 0.75).
