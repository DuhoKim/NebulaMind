...
const NOMINEES: Nominee[] = [
  {
    ...
    authors: "et al.",
    why_funny: '🎬 "Lights, Camera, Action" pun — Hollywood meets particle physics',
    emoji: "🎬",
  ...
  },
  {
    ...
    authors: "et al.",
    why_funny: "🤔 Existential crisis disguised as a research paper",
    emoji: "🤔",
  ...
  },
  {
    ...
    authors: "et al.",
    why_funny: "🌋 Surfing on lava oceans — extreme sports, cosmic edition",
    emoji: "🌋",
  ...
  },
  {
    ...
    authors: "et al.",
    why_funny: "⚡ Sounds like a Marvel villain's master plan",
    emoji: "⚡",
  ...
  },
  {
    ...
    authors: "et al.",
    why_funny: "💍 The cosmic jewelry that just won't sit straight",
    emoji: "💍",
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-gray-500 mt-1">{nom.why_funny}</p>
