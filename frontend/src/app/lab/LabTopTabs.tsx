...
// The configurator stage tabs, rendered in the sticky top banner.
// Clicking a tab selects that stage and scrolls the configurator into view.
export default function LabTopTabs() {
  ...
  return (
    <div className="lab-toptabs" role="tablist" aria-label="Configure a run">
      {STEPS.map((s) => (
        <button
          key={s.key}
          role="tab"
